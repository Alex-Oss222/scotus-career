...
**Workspace status:** Chunk 8 Run completed: 7 inventory events adjudicated; Alaska stopped as specified below. 66 Court events and one admitted institutional source are committed. Suter and Montana remain open; two source-identified Harris applications are carried without simulated action.
**Chronology cursor:** May 4, 1992, after *United States v. Williams*. All earlier stopped matters remain open; no result is inferred for them.
...
- **Manifest:** 125 items: 122 original case-list entries, the October 23 institutional change, and two source-identified Harris applications carried without adopting historical filings or actions. 67 events/sources are completed. Alaska and the two new applications have the exact blockers in §6; Suter and Montana retain their earlier blockers. Wyoming remains open for implementation.
- **Coverage:** All previously completed chunks and the Holmes correction remain effective. Chunk 8 completes Barker v. Kansas; United States Department of Energy v. Ohio; Taylor v. Freeland & Kronz; Gomez v. United States District Court for the Northern District of California; Keeney v. Tamayo-Reyes; Denton v. Hernandez; United States v. Williams. The April 21 group uses the April 6 cumulative state; the May 4 group uses the completed April 21 state. Same-day siblings do not supply one another's law. No stopped matter enters current doctrine.
- **Cursor:** May 4, 1992, after United States v. Williams. Commitment order appends entries 61–67; every earlier ledger row remains verbatim. No retrospective adjudication is performed in this Run.
...
All 67 validated records appear in the Term Working Ledger, with natural identities, effective dates and durable locations. Entries 1–60 remain verbatim, including the Holmes correction and its limited historical-snapshot supersession. Entries 61–67 complete the 7 chunk 8 events listed above. Their public projection is render-inputs/OT_1991CHUNK8.md. No existing record, Render Input or public output is edited. This Run produces no public render. All stopped matters remain unadjudicated and supply no law.
...
OT1991 diverged October 7, 1991. The unchanged opening trackers and 67 effective records reconstruct current state through May 4, 1992, after United States v. Williams. The March 24 Holmes correction remains effective on its established terms. The next untouched inventory is May 18, beginning with Foucha. Earlier source/input gaps do not supply law.

### Current law

Term Continuity Note §3 preserves the complete cumulative controlling propositions, exact authority, precedent treatment, qualifications and limits. Its chunk 8 additions state each new holding in full. Canonical records control a conflict. Alaska, Suter, Montana and the conditionally anticipated Harris applications supply no law. No separate opinion is promoted beyond a recorded majority or supported issue-specific Marks rule.
...
Wyoming retains original implementation jurisdiction. The stopped source/input matters in Note §6 remain open. A-766 concerns a distinct April 20 habeas stay; A-768 depends on verification of a later April 21 stay and application in this timeline. Neither has a simulated adjudication. Completed chunk 8 reviews end on their specific terms in §5; no retained Supreme Court proceeding or later filing is inferred from a remand.
