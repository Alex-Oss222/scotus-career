# OCTOBER TERM 1991, CHUNK 12

## Docket and Chronology

| Effective date | Case or matter | Event | Posture after event |
|---|---|---|---|
| June 18, 1992 | Nordlinger v. Hahn, No. 90-1912 | Merits decision | Affirmed; dismissal without leave to amend remains in place. |
| June 18, 1992 | Georgia v. McCollum, No. 91-372 | Merits decision | Reversed and remanded for jury selection and further proceedings under the ruling. |
| June 18, 1992 | Kraft General Foods, Inc. v. Iowa Department of Revenue and Finance, No. 90-1918 | Merits decision | Reversed and remanded for nondiscriminatory tax relief; equal protection not reached. |
| June 18, 1992 | Gade v. National Solid Wastes Management Association, No. 90-1676 | Merits decision | Reversed in part and remanded for review of the challenged provisions; unappealed ruling undisturbed. |
| June 19, 1992 | Forsyth County v. Nationalist Movement, No. 91-538 | Merits decision | Affirmed; relief against enforcement of the County fee mechanism remains for implementation below. |
| June 19, 1992 | New York v. United States, Nos. 91-543, 91-558, and 91-563 | Merits decision | Affirmed in part and reversed in part; compulsory take-title mechanism severed; remanded for declaratory relief. |
| June 19, 1992 | Wisconsin Department of Revenue v. William Wrigley, Jr., Co. | Merits decision | Reversed and remanded for further state tax proceedings. |
| June 19, 1992 | American National Red Cross v. S. G. | Merits decision | Reversed and remanded; removal sustained on the charter ground, with unresolved matters available below. |
| June 19, 1992 | Wright v. West | Merits decision | Reversed and remanded; the insufficiency ground fails, and the separate new-evidence claim remains undecided. |
| June 19, 1992 | United States v. Salerno et al., No. 91-872 | Merits decision | Reversed and remanded for consideration of actual similar motive and the resulting admissibility and judgment consequences. |

The order of entries within each date does not imply an order of decision among those cases.

## Decisions and Dispositions

### Nordlinger v. Hahn, No. 90-1912

Merits decision, June 18, 1992

#### Chronology and Posture

Argued February 25, 1992; decided June 18, 1992; [505 U.S. 1](https://www.govinfo.gov/content/pkg/USREPORTS-505/pdf/USREPORTS-505-1.pdf). On writ of certiorari to the California Court of Appeal, Second Appellate District, which affirmed dismissal without leave to amend on December 3, 1990, [225 Cal. App. 3d 1259, 275 Cal. Rptr. 684](https://static.case.law/cal-app-3d/225/html/1259-01.html). The California Supreme Court denied review on February 28, 1991. All nine Justices participated at argument and decision.

The questions are whether California’s acquisition-value property-tax assessments and its over-55 replacement-residence and parent-child reassessment exceptions deny Nordlinger equal protection, and whether she may invoke absent travelers’ rights to obtain heightened review. Nordlinger bought a Los Angeles home after renting locally. She alleges that she pays approximately five times the tax paid by longer-term owners of comparable nearby homes. California caps the tax rate and annual assessment growth and generally reassesses property upon transfer or new construction, subject to the challenged exceptions. The disparities are accepted at the pleading stage and result from the enacted acquisition-value policy. Nordlinger alleges no personal interference with interstate movement; she seeks a declaration and a tax refund.

#### Judgment

The Court affirms the rejection of Nordlinger’s own equal-protection challenge.

| Judgment component | Disposition and vote | Supporting Justices | Opposing Justices | Remedy or remand |
|---|---|---|---|---|
| Nordlinger’s own equal-protection challenge and requested tax relief | Affirmed, 8–1 | Stone-Zsela, White, Blackmun, O’Connor, Scalia, Kennedy, Souter, Thomas | Stevens | Dismissal without leave to amend stands; no refund or redesigned tax schedule is ordered. |
| Absent travelers’ claims | Not entertained; seven join the Court’s threshold ruling, and Stone-Zsela states the same refusal separately | Blackmun, White, O’Connor, Scalia, Kennedy, Souter, Thomas, Stone-Zsela | No opposing position; Stevens does not reach this issue because he would reverse on ordinary equal protection | The merits of a properly presented traveler’s claim remain open. |

#### Opinion Topology

| Writing | Author | Joined by | Relationship to judgment | Scope joined |
|---|---|---|---|---|
| Opinion of the Court | Blackmun | White, O’Connor, Scalia, Kennedy, Souter; Thomas joins Part II-A only | Affirmance | White, O’Connor, Scalia, Kennedy and Souter join all holdings and the judgment; Thomas joins only the third-party travel ruling. |
| Concurrence in part and in the judgment | Thomas | No other Justice | Affirmance | Joins Part II-A only; independently accepts rationality but rejects the distinction of Allegheny Pittsburgh. |
| Concurrence in the judgment | Stone-Zsela | No other Justice | Affirmance | Separate predictability, continuity, exception and absent-traveler grounds; does not join another writing. |
| Dissent | Stevens | No other Justice | Would reverse | Rational-basis grounds; does not reach travelers’ rights. |

#### Controlling Propositions and Authority

##### Nordlinger cannot assert absent travelers’ rights

**Controlling proposition:** A taxpayer who alleges no interference with her own interstate movement may not obtain heightened review by asserting absent travelers’ rights when she shows neither a qualifying relationship nor an obstacle to their own litigation. Nordlinger therefore cannot use those unasserted injuries to challenge this scheme; the merits of a proper traveler’s claim remain open.
...
##### Existing ownership reliance independently supports the general scheme
...
**Authority:** Blackmun’s Opinion of the Court, joined by White, O’Connor, Scalia, Kennedy and Souter; six Justices adopt this independently sufficient ground. Stone-Zsela gives a compatible separate explanation without joining the Court’s opinion.
...
The Court resolves the federal ground on which the state appellate court ruled and does not decide timeliness under California Revenue and Taxation Code §4808. It does not adjudicate a proper traveler’s claim, an independent statutory tax objection, discriminatory administration contrary to the adopted system, or the alternative ability-to-pay and revenue-stability justifications.

#### Current-Law Effect

Effective June 18, the general acquisition-value system is sustained on each of two independently sufficient rational grounds, and each specified exemption is sustained. The limit on asserting absent travelers’ rights controls. Ordinary rational-basis review applies without a new heightened proof or record-building duty. Allegheny Pittsburgh remains law at the boundary explained above. The decision creates neither a mandatory property-tax equality formula nor an immutable reliance right.
...
Supreme Court merits review is complete. The ordinary mandate leaves dismissal without leave to amend in place. The Court awards no refund, orders no reassessment or replacement tax schedule, and retains no implementation proceeding.

**End of entry: Nordlinger v. Hahn, merits decision, June 18, 1992.**
...
Argued February 26, 1992; decided June 18, 1992; [505 U.S. 42](https://www.govinfo.gov/content/pkg/USREPORTS-505/pdf/USREPORTS-505-42.pdf). On writ of certiorari to the Supreme Court of Georgia, which on July 12, 1991, affirmed the certified pretrial denial of the prosecution’s motion, [261 Ga. 473, 405 S.E.2d 688](https://static.case.law/ga/261/html/0473-01.html). Reconsideration was denied July 24, 1991. All nine Justices participated at argument and decision.

The questions are whether criminal defendants’ purposeful racial use of peremptory challenges—jury strikes ordinarily exercised without stating cause—is state action, whether the State may assert excluded jurors’ equal-protection rights, and whether that restriction is consistent with defense protections. White defendants face assault and battery charges arising from an alleged attack on African-American victims. The prosecution sought a pretrial ruling requiring race-neutral explanations if it later established initial facts supporting an inference of discriminatory defense strikes. The trial court denied the request as legally unavailable. No strike, finding of discriminatory intent, verdict or conviction is adjudicated here.
...
| Judgment component | Disposition and vote | Supporting Justices | Opposing Justices | Remedy or remand |
|---|---|---|---|---|
| Availability of a prohibition on purposeful racial defense peremptories and supported State objections | Reversed and remanded, 7–2 | Stone-Zsela, White, Blackmun, Stevens, Kennedy, Souter, Thomas | O’Connor, Scalia | Jury selection must follow the constitutional prohibition and ordinary Batson burdens; no discriminatory strike is found. |

#### Opinion Topology

| Writing | Author | Joined by | Relationship to judgment | Scope joined |
|---|---|---|---|---|
| Opinion of the Court | Blackmun | White, Stevens, Kennedy, Souter | Reversal and remand | All three controlling holdings; five-Justice opinion. |
| Concurrence in the judgment | Thomas | No other Justice | Reversal and remand | Accepts Edmonson’s controlling consequences despite his objection to its state-action premise; does not join the Court’s opinion. |
| Concurrence in the judgment | Stone-Zsela | No other Justice | Reversal and remand | Attribution limited to the selection act, State standing and unchanged Batson procedure; reserves concrete privilege questions and joins no other writing. |
| Dissent | O’Connor | No other Justice | Would affirm | Treats criminal-defense peremptories as private under Polk County despite Edmonson’s civil rule. |
| Dissent | Scalia | No other Justice | Would affirm | Considers Edmonson logically applicable but rejects extending its erroneous premise; does not join O’Connor’s dissent. |

#### Controlling Propositions and Authority

##### Purposeful racial defense peremptories are attributable to the State

**Controlling proposition:** A criminal defendant’s invocation of state peremptory authority to obtain judicial exclusion from a governmental jury is state action for that specific act, and purposeful racial exclusion violates the prospective juror’s equal-protection right. This attribution does not make defendants or defense counsel state actors in their ordinary representation, advice or investigation.
...
##### The State may assert the excluded jurors’ rights
...
The criminal charges, any particular privilege dispute, nonracial classifications and proposed safeguards against unconscious bias remain undecided. The rule does not abolish peremptory challenges or make every private act of defense counsel a constitutional matter.

#### Current-Law Effect

Effective June 18, the constitutional prohibition reaches purposeful racial peremptories by criminal defendants. State objections satisfy the specified Powers requirements, and ordinary Batson burdens govern. Polk County continues to protect ordinary independent defense representation. Wyatt’s distinct immunity question remains separate. The decision adds neither a disparate-impact rule nor a universal requirement to explain strikes.

#### Separate Positions Relevant to the Decision

Thomas accepts Edmonson’s controlling consequences but questions its state-action premise and the costs of restricting defense peremptories. O’Connor regards criminal-defense selection as private representation under Polk County. Scalia considers Edmonson logically applicable but rejects its underlying rule. Stone-Zsela separately supports attribution limited to the selection act and ordinary Batson procedure, reserving concrete privilege questions.

#### Mandate, Remedy, and Stage

Supreme Court review of the certified pretrial legal question is complete. The Georgia judgment is reversed, and the case returns for jury selection and further proceedings consistent with the ruling. The mandate reverses no conviction, finds no defendant to have discriminated, and requires no particular juror to be seated. No further Supreme Court proceeding is retained.

**End of entry: Georgia v. McCollum, merits decision, June 18, 1992.**

---

### Kraft General Foods, Inc. v. Iowa Department of Revenue and Finance, No. 90-1918

Merits decision, June 18, 1992

#### Chronology and Posture

Argued April 22, 1992; decided June 18, 1992; [505 U.S. 71](https://www.govinfo.gov/content/pkg/USREPORTS-505/pdf/USREPORTS-505-71.pdf). On writ of certiorari to the Supreme Court of Iowa, which on February 20, 1991, affirmed the challenged tax deficiency and rejected Kraft’s Commerce Clause and equal-protection claims, [465 N.W.2d 664](https://static.case.law/nw2d/465/html/0664-01.html). Reconsideration was denied March 19, 1991. All nine Justices participated at argument and decision.

The question is whether Iowa violates the Foreign Commerce Clause by taxing foreign-subsidiary dividends while deducting equivalent domestic-subsidiary dividends. The subsidiaries’ unitary relationship with Kraft and Iowa’s general authority to apportion connected income are accepted and undisputed. Kraft’s 1981 Iowa return deducted dividends from six foreign-incorporated subsidiaries operating abroad. Iowa used the federal taxable-income base with adjustments, deducted domestic dividends, and did not grant the federal foreign-tax credit. Kraft challenges the resulting deficiency. The relevant comparison concerns subsidiaries without independent Iowa operations; a subsidiary’s own Iowa business would supply a separate taxing basis.

#### Judgment

The Court reverses and remands on the foreign-commerce challenge. It does not reach the independent equal-protection claim after granting Commerce Clause relief.

| Judgment component | Disposition and vote | Supporting Justices | Opposing Justices | Remedy or remand |
|---|---|---|---|---|
| Foreign-commerce challenge to the discriminatory assessment | Reversed and remanded, 8–1 | Stone-Zsela, White, Stevens, O’Connor, Scalia, Kennedy, Souter, Thomas | Blackmun | Further state tax proceedings must supply a constitutionally adequate nondiscriminatory result; no dollar amount or particular tax-code rewrite is ordered. |
| Independent equal-protection challenge | Not reached after Commerce Clause relief | Stevens, White, O’Connor, Scalia, Kennedy, Souter, Thomas, Stone-Zsela | Blackmun would reject the claim on its merits in affirming | The Court leaves the claim undecided. |

#### Opinion Topology

| Writing | Author | Joined by | Relationship to judgment | Scope joined |
|---|---|---|---|---|
| Opinion of the Court | Stevens | White, O’Connor, Scalia, Kennedy, Souter, Thomas | Reversal and remand | Both controlling propositions and the reversal and remand; does not reach equal protection. |
| Concurrence in the judgment | Stone-Zsela | No other Justice | Reversal and remand | Separate foreign-commerce discrimination ground; does not join the Court’s opinion and reserves remedial calculations. |
| Dissent | Blackmun | No other Justice | Would affirm | Objects to the facial challenge without an overall tax-burden comparison and accepts rational administrative conformity; would reject both constitutional claims. |

#### Controlling Propositions and Authority

##### Favoring domestic dividends discriminates against foreign commerce

**Controlling proposition:** A State discriminates against foreign commerce when it includes dividends reflecting a foreign subsidiary’s foreign operations while deducting equivalent domestic dividends, even if the favored class includes corporations in every other State. For the relevant subsidiaries without independent Iowa operations, Iowa’s distinction is unconstitutional unless adequately justified; a taxpayer need not reorganize through a domestic intermediary to escape it.
...
The Court does not decide independent theories concerning international multiple taxation or the Nation’s ability to speak with one voice in foreign commerce. Equal protection, nondiscriminatory unitary taxation and remedial calculations also remain undecided. The decision gives foreign dividends no blanket immunity, does not alter Allied-Signal’s accepted boundary for a sufficient taxing connection, and does not require adoption of the entire federal tax code.

#### Current-Law Effect

Effective June 18, the specific domestic/foreign dividend distinction is invalid. The nondiscrimination requirement extends beyond preferences benefiting only the taxing State. Compelled reorganization, partial conformity to federal law, administrative convenience where reasonable neutral alternatives exist, and hypothesized taxes imposed elsewhere do not save this measure. The accepted unitary connection and the independent branches of foreign-commerce doctrine remain separate. No precedent is overruled.
...
Supreme Court merits review ends with reversal and remand. The Iowa courts must conduct further tax proceedings consistent with the nondiscrimination holding and applicable due-process remedial requirements. The Court awards no refund amount, orders no particular comprehensive tax-code revision, and retains no further proceeding.

**End of entry: Kraft General Foods, Inc. v. Iowa Department of Revenue and Finance, merits decision, June 18, 1992.**
...
Argued March 23, 1992. On writ of certiorari to the United States Court of Appeals for the Seventh Circuit. Case reference: [505 U.S. 88](https://www.govinfo.gov/content/pkg/USREPORTS-505/pdf/USREPORTS-505-88.pdf). In *National Solid Wastes Management Association v. Killian*, 918 F.2d 671 (November 14, 1990), the court of appeals vacated and remanded the District Court's disposition; rehearing was denied January 29, 1991. It rejected unapproved state regulation that directly, clearly, and substantially regulated occupational safety. It expressly condemned Illinois's 4,000-hour experience requirement and left undisturbed the unappealed District Court ruling invalidating the requirement of training within Illinois.

The question is whether §18 of the Occupational Safety and Health Act automatically displaces Illinois's hazardous-waste worker training and licensing standards on an issue covered by a federal standard whenever Illinois lacks an approved state plan, including standards that also protect the public.

OSHA's hazardous-waste standards require initial instruction, supervised experience, certification, and refresher training. Illinois requires licensing, training, examination, and, for equipment operators, 4,000 hours of experience to protect workers and the public. Illinois has no approved §18 plan. The court of appeals' direct-and-substantial overlap rule went beyond the District Court's purpose-based approach. The record contains no completed provision-by-provision review under the rule the Court adopts today. All nine Justices participated at argument and decision.

#### Judgment

The Court reverses in part and remands, by a vote of 5–4.

| Judgment component | Disposition and vote | Supporting Justices | Opposing Justices | Remedy or remand |
|---|---|---|---|---|
| Categorical preemption solely from occupational overlap and absence of an approved state plan | Reversed, 5–4; remanded | Stone-Zsela, Blackmun, Stevens, Souter, Thomas | White, O'Connor, Scalia, Kennedy | Examine the challenged provisions under the shared rejection of automatic displacement; preserve independently supported and unappealed rulings; neither wholesale enforcement nor blanket invalidation is authorized. |

#### Opinion Topology

No complete opinion commands a majority.

| Writing | Author | Joined by | Relationship to judgment | Scope joined |
|---|---|---|---|---|
| Plurality opinion announcing the judgment | Souter | Blackmun, Stevens, Thomas | Reversal and remand | Rejects automatic displacement; would permit concurrent state standards whenever compliance with both governments' requirements is physically possible. |
| Concurrence in the judgment | Stone-Zsela | No other Justice | Reversal and remand | Rejects automatic overlap preemption; permits demonstrated conflict or a clearly enacted exclusive scheme or ceiling; does not join Souter's opinion. |
| Dissent | O'Connor | White, Scalia | Would affirm | Section 18's integrated plan scheme implies exclusive regulation of covered issues; a dual purpose does not avoid it. |
| Dissent | Kennedy | No other Justice | Would affirm | Section 18's text and structure expressly require an approved plan for covered occupational standards; rejects generalized obstacle analysis. |

#### Controlling Propositions and Authority

##### Section 18 does not automatically displace compatible supplementation

**Controlling proposition:** Section 18 does not automatically preempt a supplementary state occupational-safety standard merely because a federal standard covers the same issue and the State lacks an approved plan. The categorical overlap rule is reversed; provisions must instead be examined for an actual basis of displacement, without treating either dual public purpose or occupational overlap as conclusive.
...
- Hines v. Davidowitz, 312 U.S. 52 — not overruled; no majority treats an assumed anti-duplication objective as sufficient to decide this statute. Stone-Zsela preserves demonstrated interference with a clearly enacted operation.
- Morales v. Trans World Airlines, Inc. (June 1, 1992) — distinguished; its express airline wording does not decide §18.

**Fractured-decision authority:** No Marks extraction is necessary for the expressly shared negative holding: five Justices state it at the same operative scope. Souter’s broader permission whenever simultaneous compliance is physically possible has only four votes. Stone-Zsela’s reservation for demonstrated conflict, a clear ceiling or exclusivity receives no additional formal join and is not a new Court-wide conflict test. The disagreement is not erased by calling one opinion narrower; no broader positive rule is extracted from it.

#### Limits and Current-Law Effect

An approved state plan is not an automatic prerequisite to every compatible supplementary occupational-safety standard merely because a federal standard exists. The Court rejects the categorical rule, while leaving provision-specific review for further proceedings. It does not endorse every compatible state license or decide that any particular provision survives review. No five-Justice opinion adopts a complete replacement test for conflict. Existing conflict principles remain in force; actual statutory ceilings, exclusivity, savings provisions, and proved incompatibility must be respected on their own terms. Section 4(b)(4), 29 U.S.C. §653(b)(4), remains operative: it provides that nothing in the Act supersedes or affects any workers'-compensation law, or enlarges, diminishes, or otherwise affects the common-law or statutory rights, duties, or liabilities of employers and employees under any law with respect to employees' work-related injuries, diseases, or death. This savings clause does not decide the occupational-license preemption question presented here.

#### Separate Positions Relevant to the Decision

Justice Souter, joined by Justices Blackmun, Stevens, and Thomas, would permit concurrent regulation whenever compliance with both sets of requirements is physically possible. Chief Justice Stone-Zsela concurs in reversal but preserves displacement based on demonstrated conflict or a clearly enacted federal ceiling or exclusive arrangement. Justice O'Connor, joined by Justices White and Scalia, would affirm because the integrated state-plan scheme excludes unapproved regulation of covered issues. Justice Kennedy would separately affirm on the statute's express structure, while rejecting a broad judicial inference of conflict from duplication.

#### Mandate, Remedy, and Stage

Supreme Court review is complete. The Seventh Circuit's judgment is reversed insofar as it establishes automatic displacement from occupational overlap and the absence of an approved plan, and the case is remanded for further proceedings. Its ruling on the 4,000-hour requirement cannot rest solely on that rejected rationale. The unappealed District Court invalidation of training within Illinois remains undisturbed. Preserved alternative grounds, the coverage of individual provisions, and severability remain for lawful proceedings. The Court makes no Commerce Clause merits ruling, authorizes neither wholesale enforcement nor blanket invalidation, and sets no mandate-issuance date. No further Supreme Court matter is retained; no later rulemaking, license, filing, or hearing is established.

**End of entry: Gade v. National Solid Wastes Management Association, merits decision, June 18, 1992.**

---

### Forsyth County v. Nationalist Movement, No. 91-538

Merits decision, June 19, 1992

#### Chronology and Posture

Argued March 31, 1992. On writ of certiorari to the United States Court of Appeals for the Eleventh Circuit, 913 F.2d 885 and 934 F.2d 1482. Case reference: [505 U.S. 123–143](https://tile.loc.gov/storage-services/service/ll/usrep/usrep505/usrep505123/usrep505123.pdf). The court of appeals reversed the District Court's rejection of the facial challenge to the County's demonstration fees, reasoning that only a nominal fee was permissible.

The Court considers whether the fee mechanism violates the First Amendment, including the asserted nominal-fee ceiling and the independently pleaded defects in the licensing scheme. The Nationalist Movement seeks an injunction against enforcement. The separate City and School Board permit controversies are outside this review. All nine Justices participated at argument and decision.

#### Judgment

The Court affirms the judgment invalidating the County's challenged fee mechanism because it gives officials unbounded discretion and permits charges based on a demonstration's content. The Court rejects a universal nominal-fee ceiling.

| Judgment component | Disposition and vote | Supporting Justices | Opposing Justices | Remedy or remand |
|---|---|---|---|---|
| County fee mechanism | Affirmed, 6–3 | Stone-Zsela, Blackmun, Stevens, O'Connor, Kennedy, Souter | White, Scalia, Thomas | Facial relief against enforcement stands. The dissenting Justices would reverse the nominal-fee basis and remand the other claims. Proceedings below implement the affirmed judgment. |

#### Opinion Topology

| Writing | Author | Joined by | Relationship to judgment | Scope joined |
|---|---|---|---|---|
| Opinion of the Court | Blackmun | Stevens, O'Connor, Kennedy, Souter | Affirms | Entire opinion; both facial grounds independently control, and the opinion rejects an amount-only rule. |
| Concurrence in the judgment | Stone-Zsela | No other Justice | Affirms | Bounded licensing and content-neutrality grounds; independent support without a formal join in another opinion. |
| Dissent | White | Scalia, Thomas | Would reverse the nominal-fee rule and remand the remaining facial grounds | Entire dissent. |

#### Controlling Propositions and Authority

##### Facial review and bounded licensing discretion

**Controlling proposition:** A licensing rule directed at protected demonstrations is facially invalid when neither its text, authoritative construction, nor established administration supplies narrow, objective, definite standards controlling whether and how much officials charge. A challenger need not prove discriminatory administration of its own application, and a maximum fee does not supply the missing standards.
...
- Simon & Schuster, Inc. v. Members of the New York State Crime Victims Board, December 10, 1991 decision: consistent application of the prohibition on unjustified content-based financial burdens; its separate remedial limits are unchanged.
...
##### No universal nominal-fee ceiling
...
The fee mechanism cannot be enforced against protected demonstrations. Unbounded discretion in licensing expression and permit pricing based on audience hostility each independently support that result. A cap cures neither defect; fees exceeding a nominal amount remain permissible if otherwise lawful. The County may adopt lawful neutral coordination rules and a sufficiently bounded cost policy. No precedent is overruled. A five-Justice Court opinion controls every holding, so no rule must be drawn from competing separate opinions.

The Court does not decide concrete indigency rules, the validity of fixed neutral fees or particular content-independent administrative costs, or municipal funding duties. It prescribes neither a fee amount nor a mandatory spending formula and awards no damages or refund amount. The City and School Board claims remain outside this review.

#### Separate Positions Relevant to the Decision

Justice White, joined by Justices Scalia and Thomas, would correct the court of appeals' nominal-fee rule under *Cox*, which permits lawful nondiscriminatory regulatory fees, and remand the other challenges for initial findings below. The dissent does not approve fees based on hostile audiences or unlimited discretion; it disputes whether the Court should resolve those defects on this review. Chief Justice Stone-Zsela concurs in the judgment, applying the same facial-review and neutrality rules without regard to the speaker's viewpoint. He reserves concrete indigency, fixed neutral fees, and municipal spending questions and does not formally join the Court's opinion.

#### Mandate, Remedy, and Stage

Supreme Court merits review is complete. Affirmance of the County portion leaves the facial protection against enforcement in place, with implementation returned to the lower courts through the ordinary mandate. No further Supreme Court merits action is ordered, and no separate review of the City or School Board controversy is added.

**End of entry: Forsyth County v. Nationalist Movement, merits decision, June 19, 1992.**

---

### New York v. United States, Nos. 91-543, 91-558, and 91-563

Merits decision, June 19, 1992

#### Chronology and Posture

Argued March 30, 1992. On writs of certiorari to the United States Court of Appeals for the Second Circuit, 942 F.2d 114. Case reference: [505 U.S. 144–213](https://tile.loc.gov/storage-services/service/ll/usrep/usrep505/usrep505144/usrep505144.pdf). These consolidated cases are No. 91-543, *New York v. United States et al.*; No. 91-558, *County of Allegany, New York v. United States et al.*; and No. 91-563, *County of Cortland, New York v. United States et al.* The court of appeals affirmed the District Court's rejection of constitutional challenges to the 1985 Low-Level Radioactive Waste Policy Amendments Act, treating the evidentiary dismissal as summary judgment.

The State and counties seek declaratory relief under the Tenth Amendment and the Guarantee Clause against the Act's monetary, access, and take-title provisions. Severability—whether the rest of the Act can remain in force if a provision is invalid—is also at issue. The due process and Eleventh Amendment claims have been abandoned. All nine Justices participated at argument and decision.

#### Judgment

In each docket, the Court affirms as to the monetary and access incentives and the remaining Guarantee Clause claim, reverses as to the compulsory take-title mechanism, severs that mechanism, and remands for corresponding declaratory relief.

| Judgment component, in all three dockets | Disposition and vote | Supporting Justices | Opposing Justices | Remedy or limit |
|---|---|---|---|---|
| Monetary incentives | Affirmed, 9–0 | Stone-Zsela, White, Blackmun, Stevens, O'Connor, Scalia, Kennedy, Souter, Thomas | — | Lawful surcharge collection and distributions remain operative. |
| Access incentives | Affirmed, 9–0 | Stone-Zsela, White, Blackmun, Stevens, O'Connor, Scalia, Kennedy, Souter, Thomas | — | Authorized higher costs and exclusion remain operative; other States have no duty to accept New York's waste. |
| Compulsory title, possession, and associated liability | Reversed, 6–3 | Stone-Zsela, O'Connor, Scalia, Kennedy, Souter, Thomas | White, Blackmun, Stevens, who would affirm | Declare the compulsory mechanism invalid. |
| Severance and corresponding remand | Remainder preserved; remanded, 6–3 | Stone-Zsela, O'Connor, Scalia, Kennedy, Souter, Thomas | White, Blackmun, Stevens, who would affirm and preserve the entire Act | Sever the compulsory mechanism; no federal replacement program is created. |
| Remaining Guarantee Clause challenge | Rejected, 9–0 in result | Stone-Zsela, White, Blackmun, Stevens, O'Connor, Scalia, Kennedy, Souter, Thomas | — | The five-Justice Court opinion assumes the claim may be heard; Stone-Zsela alone separately decides that this limited claim may be heard. No majority adopts that affirmative justiciability conclusion. |

#### Opinion Topology

| Writing | Author | Joined by | Relationship to judgment | Scope joined |
|---|---|---|---|---|
| Opinion of the Court | O'Connor | Scalia, Kennedy, Souter, Thomas | Divided disposition | All parts; five Justices control the statutory construction, structural invalidation, limited Guarantee Clause merits, and severance. |
| Opinion of the Court, Parts III-A and III-B | O'Connor | White, Blackmun, Stevens additionally join Scalia, Kennedy, Souter, Thomas | Affirms the monetary and access incentives | Parts III-A and III-B only for White, Blackmun, and Stevens; eight Justices join these incentive sections. |
| Concurrence in the judgment | Stone-Zsela | No other Justice | Same divided disposition | Does not formally join another opinion; affirmatively reaches only the limited institutional Guarantee Clause claim, then rejects it. |
| Opinion concurring in part and dissenting in part | White | Blackmun, Stevens | Would affirm the entire scheme | Entire separate opinion; joins the Court only in Parts III-A and III-B. |
| Opinion concurring in part and dissenting in part | Stevens | No other Justice | Would affirm the entire scheme | Additionally defends broader congressional power to issue commands directed at States. |

#### Controlling Propositions and Authority

##### Present review of the future take-title obligation

**Controlling proposition:** A challenge to a future statutory obligation is ripe where the legal issue is fit for decision and avoiding that obligation requires substantial present action over many years. New York may challenge the 1996 take-title command now because its siting choices must be made now and waste production will continue.
...
- Pacific Gas & Electric Co. v. State Energy Resources Conservation and Development Commission, 461 U.S. 190 (1983): applied in its presently consequential future-obligation setting.
- Regional Rail Reorganization Act Cases, 419 U.S. 102 (1974): applied; a future statutory obligation can warrant present review when it already requires consequential action.

##### No independent command in the responsibility clause

**Controlling proposition:** Read as a whole, the Act's general state-responsibility language describes the objective implemented by its specified incentives and adds no independently enforceable command to regulate. That plausible construction avoids serious structural problems without contradicting Congress's arrangement.
...
**Controlling proposition:** Congress may authorize the stated interstate waste surcharges, collect a share for a segregated federal spending program, and condition distributions on explicit, disposal-related milestones. On this record these conditions are authorized inducements, not an unconstitutional command to state government; segregation of the funds and state choice whether to qualify do not remove the program from the spending power.
...
- Wyoming v. Oklahoma, January 22, 1992 decision: distinguished on the decisive express-congressional-authorization ground; unilateral state discrimination remains invalid.
...
- Hodel v. Virginia Surface Mining & Reclamation Assn., 452 U.S. 264 (1981): applied by analogy to a lawful alternative borne outside the unwilling State government; this Act does not supply the federal fallback present in Hodel.
...
- Fort Gratiot Sanitary Landfill v. Michigan Department of Natural Resources, June 1, 1992 decision: distinguished; unauthorized origin-based private-waste exclusion remains impermissible.
- Chemical Waste Management v. Hunt, June 1, 1992 decision: distinguished; its invalid unauthorized discriminatory surcharge is not approval or disapproval of the express federal choices here.

##### Compulsory state ownership or regulation

**Controlling proposition:** Congress may not use its ordinary commerce authority to make an unwilling State choose between regulating private waste generators under federal instructions and accepting their waste into state ownership and possession with associated liability. Combining two unauthorized commands does not create a lawful option, and state officials' advocacy for the statute does not enlarge Congress's powers or estop this noncompacting State from challenging the command.
...
##### The remaining Guarantee Clause claim

**Controlling proposition:** Assuming without deciding that this Guarantee Clause claim may be heard, the surviving monetary and access incentives do not deny New York a republican form of government because they preserve its legislative choices and officials' accountability to its voters. The Court decides neither general Guarantee Clause justiciability nor a separate Guarantee objection to the already invalidated take-title command.
...
The monetary and access mechanisms continue in force. The compulsory transfer of title, possession, and liability is invalid and severed. The general state-responsibility language creates no independently enforceable command to regulate.

Congress retains direct authority over the interstate disposal market, authorized conditional spending, and lawful cooperative arrangements. *Garcia* continues to govern generally applicable regulation of state activity. The Court clarifies and extends *Hodel*'s structural limit to the unavoidable choice between state administration and compulsory ownership of private waste. Actual compact obligations, direct regulation of state market conduct, and independently authorized state-court or judicial duties remain distinct. The Court fixes no new funding-coercion percentage.

The remaining Guarantee Clause claim fails, but the general availability of judicial review under that Clause remains open. Chief Justice Stone-Zsela's affirmative decision to hear the limited institutional claim is not the Court's rule. *Alaska Airlines* supplies the unchanged severability standard. Each controlling holding has at least five formal adherents in the Court's opinion; no governing rule must be extracted from the separate writings.

#### Separate Positions Relevant to the Decision

Chief Justice Stone-Zsela concurs in the judgment without formally joining the Court's opinion. He agrees that the monetary and access provisions leave lawful choices, that compulsory ownership and administration exceed ordinary commerce authority, and that severance preserves the statute. He separately finds the limited institutional Guarantee Clause claim judicially manageable under *Baker*, which addresses the political-question boundary, because the claim asks whether state legislative choice has been displaced. He then rejects it on the merits. He reserves other Guarantee Clause theories and supplies no additional Guarantee Clause ground for invalidating take-title. His affirmative justiciability position does not control.

Justice White, joined by Justices Blackmun and Stevens, would uphold the whole negotiated arrangement. New York's participation and benefits, *Garcia*'s political safeguards, and *FERC*'s cooperative framework support the bargain, which they consider an interstate agreement New York should honor. Justice Stevens additionally argues that the Constitution's enlargement of federal power did not prohibit directions to States. His broader command theory is his own. Neither dissenting theory controls.

#### Mandate, Remedy, and Stage

Supreme Court merits review is complete. Each consolidated docket is remanded for declaratory relief corresponding to the invalidity and severance of the compulsory title, possession, and liability mechanism. The remaining financing and access scheme stays operative. No damages award, disposal site, federal administrator, replacement program, or compulsory acceptance obligation for another State is ordered. The Court neither adjudicates an actual compact obligation nor revives an abandoned constitutional claim. The lower courts will implement the declaratory relief on remand.

**End of entry: New York v. United States, merits decision, June 19, 1992.**
...
Argued January 22, 1992. On writ of certiorari to the Supreme Court of Wisconsin under 28 U.S.C. §1257. That court, 160 Wis. 2d 53, 465 N.W.2d 800 (February 19, 1991), reversed the intermediate court and disallowed Wisconsin's assessed franchise tax under 15 U.S.C. §381. Reporter reference: [505 U.S. 214](https://tile.loc.gov/storage-services/service/ll/usrep/usrep505/usrep505214/usrep505214.pdf).

The question is what activities constitute solicitation of orders under §381(a), and whether Wrigley's additional Wisconsin activities remove the statutory protection from net-income taxation.

Wisconsin assessed an income-based franchise tax in 1980 for 1973–1978. Wrigley's local representatives solicited orders approved in Chicago and fulfilled from outside Wisconsin. They also regularly exchanged stale gum, sometimes sold replacement display stock through agency-stock checks, and maintained inventory at home or in reimbursed rented space. Recruitment, training, evaluation, sales meetings, and limited mediation of credit disputes accompanied the solicitation. The administrative testimony was accepted as credible. The Wisconsin Supreme Court associated the activities closely with solicitation and did not resolve penalty interest. No constitutional tax calculation or unrelated defense must be decided to resolve §381 coverage.
...
The Court reverses the judgment of the Supreme Court of Wisconsin and remands for further proceedings consistent with its construction of §381.

| Judgment component | Disposition and vote | Supporting Justices | Opposing Justices | Remedy or remand |
|---|---|---|---|---|
| Question under review | Reversed and remanded, 7–2 | Stone-Zsela, White, Stevens, O’Connor, Scalia, Souter, Thomas | Blackmun, Kennedy | The statutory barrier to the challenged net-income tax is removed. Further state proceedings may address remaining valid defenses, penalty interest if properly open, and lawful calculation. The Court does not fix a tax amount or decide an independent constitutional objection. |

#### Opinion Topology

| Writing | Author | Joined by | Relationship to judgment | Scope joined |
|---|---|---|---|---|
| Opinion of the Court | Scalia | White, Stevens, Souter, Thomas | Supports reversal and remand. | Entire opinion: Parts I–II, background and statutory standards; Part III, application and disposition. |
| Concurrence in part and in the judgment | O’Connor | No additional joiners | Supports reversal and remand. | Joins Parts I–II of Scalia’s opinion only; no join in Part III. Her separate application excludes stale-gum replacement from unprotected activity but finds inventory and stock-check sales sufficient. |
| Concurrence in the judgment | Stone-Zsela | No additional joiners | Supports reversal and remand. | Independent functional construction, combined-activity application and narrow trivial-departure qualification; no formal join in another opinion. |
| Dissent | Kennedy | Blackmun | Would affirm the statutory protection. | Entire dissent; reasonable-buyer inquiry into significant independent service or value. |
...
**Controlling proposition:** Activities outside protected solicitation do not defeat §381 protection when they are too slight to create a nontrivial additional connection with the taxing State—but the inquiry considers the unprotected activities together and is not resolved by their small proportion of the company’s total sales. Wrigley’s recurring stale-gum exchanges, stock-check sales and supporting inventory together create that additional connection, making §381 protection unavailable for the assessed years.
...
Effective June 19, 1992, §381 protects activities entirely ancillary to solicitation—those serving no independent business function—and tolerates departures too slight to create a nontrivial additional connection with the State. These rules define the previously open statutory boundaries. The requirements of out-of-state approval and fulfillment, the statutory distinction between company offices and independent contractors, and separate constitutional tax rules remain. The Court adopts no fixed amount, sales ratio, automatic exclusion of activity after a sale, tax assessment amount, or broader constitutional rule. Whether each unprotected activity would independently remove protection remains undecided.

#### Separate Positions Relevant to the Decision

O’Connor agrees with the statutory standards but treats stale-gum replacement as part of making the solicited product available; inventory and paid stock-check deliveries still remove protection in her view. Kennedy, joined by Blackmun, would ask whether reasonable buyers receive a significant independent service or component of value and would regard these limited freshness and display practices as part of solicitation. Stone-Zsela’s judgment concurrence describes the trivial-departure qualification as a construction of the statutory business-activity category, preserves genuinely isolated acts and rejects both a fixed dollar line and any rule treating proportional smallness as dispositive.

#### Mandate, Remedy, and Stage

Supreme Court merits review is complete. The case returns to the Wisconsin courts for lawful assessment proceedings consistent with the statutory holding. Further proceedings may address remaining valid defenses, penalty interest if properly open, and lawful calculation. The Court fixes no tax amount and decides no independent constitutional objection. No new filing, deadline, mandate-issuance date, retained jurisdiction, or later lower-court outcome is established.

**End of entry: Wisconsin Department of Revenue v. William Wrigley, Jr., Co., merits decision, June 19, 1992.**
...
Argued March 3, 1992. On writ of certiorari to the United States Court of Appeals for the First Circuit under 28 U.S.C. §1254(1). The First Circuit, 938 F.2d 1494 (July 24, 1991), reversed the District Court's denial of remand on an interlocutory appeal—review before final judgment—authorized under §1292(b). Reporter reference: [505 U.S. 247](https://tile.loc.gov/storage-services/service/ll/usrep/usrep505/usrep505247/usrep505247.pdf).

The question is whether the Red Cross charter's authorization to sue and be sued in state or federal courts confers original federal jurisdiction permitting removal of this state-law action to federal court.

S. G. and her husband alleged that blood supplied by the Red Cross caused an HIV infection during surgery. Their state-law action against the Red Cross was removed before the state court decided consolidation with actions against the surgeon's estate and equipment manufacturer. The Red Cross invoked both charter jurisdiction and diversity. The District Court denied remand and certified the charter issue for interlocutory review. The First Circuit rejected special jurisdiction but left the proposed joinder, which could defeat diversity, for further consideration. It did not establish that every independent federal basis was absent. It also left alternative arguments about the complaint rule and abstention unresolved. The allegations establish no finding of contamination, negligence, causation, or damages.

Chief Justice Stone-Zsela and Justices White, Blackmun, Stevens, O'Connor, Scalia, Kennedy, Souter, and Thomas participated at argument and decision.

#### Judgment

The Court reverses the First Circuit's judgment and remands for further proceedings consistent with the charter's grant of original federal jurisdiction.

| Judgment component | Disposition and vote | Supporting Justices | Opposing Justices | Remedy or remand |
|---|---|---|---|---|
| Question under review | Reversed and remanded, 6–3 | Stone-Zsela, White, Blackmun, Stevens, Souter, Thomas | O’Connor, Scalia, Kennedy | Removal under §1441 is sustained on the charter ground. The federal proceedings continue subject to unresolved matters properly available below. The Court does not establish diversity, require or forbid joinder, adjudicate tort liability, create substantive federal tort law or confer immunity. |

#### Opinion Topology

| Writing | Author | Joined by | Relationship to judgment | Scope joined |
|---|---|---|---|---|
| Opinion of the Court | Souter | White, Blackmun, Stevens, Thomas | Supports reversal and remand. | Entire opinion: special charter jurisdiction, independent removal ground and Article III authority. |
| Concurrence in the judgment | Stone-Zsela | No additional joiners | Supports reversal and remand. | Independent charter-specific text and precedent ground, with express reservations for different charters, alternative removal grounds, immunity and substantive law; no formal join in another opinion. |
| Dissent | Scalia | O’Connor, Kennedy | Would affirm the First Circuit’s charter ruling and preserve its conditional diversity/joinder posture. | Entire dissent on the charter’s capacity-only meaning; does not reach Article III. |

#### Controlling Propositions and Authority

##### The express federal-court clause grants original jurisdiction

**Controlling proposition:** The Red Cross charter’s authorization to sue and be sued in courts of law and equity, State or Federal, confers original federal jurisdiction over actions to which the Red Cross is a party. In construing a congressional charter’s sue-and-be-sued clause, a specific mention of federal courts permits a jurisdictional reading that general corporate-capacity language does not; the charter grant here operates independently of federal incorporation alone.
...
Effective June 19, 1992, the charter itself provides original federal jurisdiction and a §1441 removal basis for this Red Cross action; a federal claim under §1331 is not required. Article III permits that specific grant. Section 1349's general limitation on jurisdiction based on federal incorporation and the precedents construing general capacity clauses remain in force; §1349's application to nonstock corporations remains unresolved. Federal jurisdiction creates no federal substantive tort law, immunity, or liability. Different charter language, diversity, joinder, and independently available abstention remain outside the decision.

#### Separate Positions Relevant to the Decision

Scalia, joined by O’Connor and Kennedy, reads the clause as granting corporate capacity only: its symmetric state/federal wording and place in the list of powers differ from Osborn, while D’Oench contained express arising-under language. They would preserve the First Circuit’s conditional remand posture and do not reach Article III. Stone-Zsela’s judgment concurrence confines its reasoning to this charter’s explicit federal reference in its established legal context and reserves different wording, alternative removal grounds, immunity and substantive law.

#### Mandate, Remedy, and Stage

Supreme Court review of the charter issue is complete. Removal under §1441 is sustained on the charter ground. The case returns through the First Circuit for federal proceedings consistent with that holding and for unresolved matters properly available below. The Court neither requires nor forbids joinder. It does not establish diversity or decide tort liability. No tort findings, damages, new filing, deadline, mandate-issuance date, or retained Supreme Court supervision are established.

**End of entry: American National Red Cross v. S. G., merits decision, June 19, 1992.**
...
Argued March 24, 1992. On writ of certiorari to the United States Court of Appeals for the Fourth Circuit under 28 U.S.C. § 1254(1). The court of appeals, [931 F.2d 262](https://static.case.law/f2d/931/cases/0262-01.json), decided April 29, 1991, and amended June 21, 1991, reversed the District Court’s denial of habeas relief on West’s claim that the evidence was insufficient and remanded for a writ. Case reference: [505 U.S. 277](https://tile.loc.gov/storage-services/service/ll/usrep/usrep505/usrep505277/usrep505277.pdf). All nine Justices participated at argument and decision.

The questions are whether the trial evidence was constitutionally sufficient to sustain West’s larceny conviction on federal habeas review and whether the proposed framework under Teague changes review of state courts’ applications of federal law. The Court’s additional-briefing question concerned deference to state determinations applying law to particular facts.

Police recovered more than 15 distinctive items stolen from Cardova’s home in West’s residence two to four weeks after the theft. His trial account of buying and selling at flea markets was confused, incomplete and uncorroborated, and left major items unexplained. His prior felony was available to assess credibility, not as independent proof that he committed this theft. Virginia’s grand-larceny threshold at the time of the offense was $100. The jury instructions left the State responsible for proving every element beyond a reasonable doubt while permitting an inference from unexplained or falsely explained recent possession.

Direct and state collateral review rejected the insufficiency claim. The federal District Court rejected that claim and a separate claim based on Elkins’s later statement. The Fourth Circuit used contextual considerations drawn from Cosby v. Jones to find the record insufficient and left the Elkins claim unaddressed. West’s exhausted claim under Jackson v. Virginia challenges the sufficiency of this trial record; it does not challenge every possession inference on its face or present an independently preserved objection to the jury instructions.

#### Judgment

The Court unanimously reverses the Fourth Circuit’s judgment and remands for further proceedings. Habeas relief on the record-based Jackson insufficiency claim is rejected.

| Judgment component | Disposition and vote | Supporting Justices | Opposing Justices | Remedy or remand |
|---|---|---|---|---|
| Exhausted Jackson insufficiency ground | Reversed and remanded, 9–0 | Stone-Zsela, White, Blackmun, Stevens, O’Connor, Scalia, Kennedy, Souter, Thomas | No Justice dissents | The direction to issue a writ on insufficiency grounds cannot stand. The separate new-evidence claim remains for its own lawful disposition on remand. |

#### Opinion Topology

| Writing | Author | Joined by | Relationship to judgment | Scope joined |
|---|---|---|---|---|
| Opinion announcing the judgment | Thomas | Scalia | Reversal and remand on evidentiary sufficiency | Entire principal opinion. Applies Jackson to this evidence and reserves selection of a broad legal-review standard. Its discussion of the history of habeas review and deference has no majority join. |
| Concurrence in the judgment | White | No other Justice | Reversal and remand on evidentiary sufficiency | Expressly adopts the principal opinion’s record-specific Jackson sufficiency demonstration, without formally joining its other reasoning. |
| Concurrence in the judgment | O’Connor | Blackmun, Stevens | Reversal and remand on evidentiary sufficiency | Entire concurrence. Finds sufficient evidence under Jackson and rejects the suggestion that Teague itself replaces independent review of existing federal law. |
| Concurrence in the judgment | Kennedy | No other Justice | Reversal and remand on evidentiary sufficiency | Entire concurrence. Adopts Jackson sufficiency and distinguishes retroactivity from independent review of questions applying law to facts; reserves whether this particular requested application would be new. |
| Concurrence in the judgment | Souter | No other Justice | Reversal and remand on the threshold new-rule ground | Teague alone. Treats the specific postfinality restriction on the established inference from falsely explained possession as new; does not reach the merits as a ground or join the sufficiency proposition. |
| Concurrence in the judgment | Stone-Zsela | No other Justice | Reversal and remand on evidentiary sufficiency | Independently applies Jackson, with limits on possession and credibility evidence, preservation of the State’s burden, and exclusion of propensity reasoning; formally joins no other opinion and adopts no broad new review standard. |

No complete opinion commands a majority. The narrow sufficiency proposition below has eight express supporters through their respective writings; that agreement does not make those Justices formal joiners of a single opinion.

#### Controlling Propositions and Authority

##### The trial record permits a rational finding of larceny under Jackson

**Controlling proposition:** On the trial record here, the quantity and recency of West’s possession of distinctive items from the same theft, considered with the jury’s permissible rejection of his incomplete account, allow a rational trier of fact to find the elements of larceny beyond a reasonable doubt; the exhausted Jackson insufficiency claim therefore warrants no habeas relief. The reviewing court must assess the evidence and permissible credibility choices favorably to the prosecution, without retrying guilt, shifting the State’s burden or treating possession as an invariably sufficient substitute for proof of theft.

**Authority:** Thomas and Scalia expressly adopt this Jackson application in the principal opinion. White expressly endorses its sufficiency demonstration in his concurrence in the judgment; O’Connor, Blackmun and Stevens adopt the same record-specific sufficiency conclusion in their concurrence; Kennedy expressly adopts it in his concurrence; and Stone-Zsela independently adopts it in his concurrence in the judgment. These eight Justices expressly support the same operative proposition through their own writings. Souter’s ground rests on Teague alone and does not support this proposition. No complete opinion commands a majority, and there is no broader controlling holding under Marks.
...
- In re Winship, 397 U.S. 358: retained; the State must prove each element beyond a reasonable doubt and no burden shifts to West.
- Barnes v. United States, 412 U.S. 837: its permissive-inference principle remains consistent background, not a rule automatically equating any possession with theft.
- Cosby v. Jones, 682 F.2d 1373 (11th Cir. 1982): its contextual considerations do not replace Jackson or support the Fourth Circuit’s insufficiency conclusion on this record; the Court adopts no general five-factor constitutional test.

#### Limits and Current-Law Effect

The Court applies the existing Jackson standard without adding a burden, degree of proof, presumption, corroboration requirement or categorical rule equating possession with theft. Teague and its existing exceptions, Miller’s distinction between legal and factual questions, and the then-existing § 2254(d) remain in force. The Court adopts no general rule requiring acceptance of every reasonable state-court decision.

The separate writings disagree about when Teague must be considered and how it applies here. Souter’s new-rule ground has no controlling coalition. The broader discussion of independent review by O’Connor, Blackmun, Stevens and Kennedy does not acquire controlling force through Stone-Zsela’s narrower sufficiency position. Marks supplies no common rationale combining a Teague bar with a denial on the merits. The alternative Elkins claim remains undecided.

#### Separate Positions Relevant to the Decision

Thomas, joined by Scalia, finds the trial evidence sufficient whatever the answer to the proposed broader review question and leaves that choice open. White endorses that application of Jackson. O’Connor, joined by Blackmun and Stevens, and Kennedy separately explain that Teague’s inquiry into the retroactive use of new rules does not itself replace independent application of existing federal law. Kennedy reserves whether this particular Jackson claim would require a new rule because it already fails on the merits.

Souter would stop at Teague. In his view, the later restriction imposed on the established inference from falsely explained recent possession was not dictated when the conviction became final. Stone-Zsela applies Jackson independently, confines disbelief to its proper role alongside affirmative evidence, preserves the State’s burden and rejects use of the prior felony as proof of a propensity to commit this theft. He finds no occasion for the proposed general change in the review framework.

#### Mandate, Remedy, and Stage

Review of the insufficiency ground is complete. The case returns through the Fourth Circuit for proceedings rejecting that ground and addressing any other properly remaining claim, including the previously unaddressed Elkins new-evidence claim under its own requirements. The Court orders no new trial, acquittal, release, expansion of custody or disposition of every habeas claim. It establishes no special mandate-issuance date or later filing and retains no Supreme Court proceeding.

**End of entry: Wright v. West, merits decision, June 19, 1992.**

---

### United States v. Salerno et al., No. 91-872

Merits decision, June 19, 1992

#### Chronology and Posture

Argued April 20, 1992. On writ of certiorari to the United States Court of Appeals for the Second Circuit, reviewing [937 F.2d 797](https://static.case.law/f2d/937/html/0797-01.html), amended on rehearing at [952 F.2d 623](https://static.case.law/f2d/952/html/0623-01.html). This case concerns the admission of former testimony, with case reference [505 U.S. 317](https://www.govinfo.gov/content/pkg/USREPORTS-505/pdf/USREPORTS-505-317.pdf). Chief Justice Alex-Lamar Stone-Zsela and Justices White, Blackmun, Stevens, O’Connor, Scalia, Kennedy, Souter and Thomas participated at argument and decision.

The District Court excluded grand-jury testimony offered by the defense and entered convictions. The court of appeals reversed the appealing defendants’ convictions, treating similar motive as dispensable and finding spillover from the evidentiary ruling. The seven respondents before this Court are Anthony Salerno, Vincent DiNapoli, Louis DiNapoli, Nicholas Auletta, Edward Halloran, Alvin O. Chattin and Aniello Migliore. Ianniello’s distinct appellate relief is outside this writ.

The question is whether unavailable witnesses’ grand-jury testimony may be admitted for the defense under Federal Rule of Evidence 804(b)(1) without showing that the Government had a similar motive to develop it, including the asserted fairness and forfeiture grounds. The United States seeks reversal; the respondents defend admission and their appellate relief.

#### Judgment

The Court reverses and remands the Second Circuit’s judgment insofar as it dispenses with the similar-motive requirement, by a vote of 8–1. Stevens dissents.

| Judgment component | Disposition and vote | Supporting Justices | Opposing Justice | Remedy or remand |
|---|---|---|---|---|
| Dispensation with similar motive for the seven respondents | Reversed and remanded, 8–1 | Stone-Zsela, White, Blackmun, O’Connor, Scalia, Kennedy, Souter, Thomas | Stevens | Consider actual similar motive and the resulting admissibility and judgment consequences, preserving independent appellate grounds. |

#### Opinion Topology

| Writing | Author | Joined by | Relationship to judgment | Scope joined |
|---|---|---|---|---|
| Opinion of the Court | Thomas | White, Blackmun, O’Connor, Scalia, Kennedy, Souter | Reversal and remand | Full opinion; both controlling propositions. |
| Concurrence | Blackmun | No other Justice | Joins the Court in full | Similar motive is a contextual factual inquiry; it requires neither an identical motive nor an always-or-never rule. |
| Concurrence in the judgment | Stone-Zsela | No other Justice | Reversal and remand | Every Rule condition, actual comparable motive, no forfeiture from independent contradiction, and preservation of independent appellate grounds; no formal join in the Court’s opinion. |
| Dissent | Stevens | No other Justice | Would affirm | The existing record on the central issue establishes actual opportunity and similar motive; tactical restraint is not absence of motive. |

#### Controlling Propositions and Authority

##### Every condition of the former-testimony exception remains necessary

**Controlling proposition:** A party offering an unavailable witness’s former testimony under Federal Rule of Evidence 804(b)(1) must establish that the opposing party had both an opportunity and a similar motive to develop that testimony; the Government’s power to immunize the witness at trial and an appeal to adversarial fairness do not dispense with either requirement. Similar motive must be considered on the actual proceedings and arguments; this decision neither finds that condition satisfied here nor establishes a categorical exclusion of grand-jury testimony.

**Authority:** Thomas’s Opinion of the Court, joined in full by White, Blackmun, O’Connor, Scalia, Kennedy and Souter. These seven of the nine participating Justices adopt this rule and explanation. Stone-Zsela concurs in the judgment on his separately stated compatible rule and qualifications, without formally joining the opinion. Stevens dissents from the remand on the application of actual motive, not on an exemption from the Rule.
...
- Green v. Bock Laundry Machine Co., 490 U.S. 504 (1989): applied for enforcing the enacted evidentiary rule rather than altering it for a preferred litigation result; Green’s separate impeachment rule is unchanged.
...
- United States v. Miller, 600 F.2d 498 (5th Cir. 1979): distinguished on the premise of selective disclosure; the Court rejects the proposed analogy without adopting a general rule equating hearsay with testimonial privilege. Miller is a Fifth Circuit decision, not a prior holding of this Court.

#### Limits and Questions Not Reached

The parties’ actual-motive arguments and the resulting admissibility and judgment consequences return for consideration. The Court makes no finding of actual similar motive, perjury, ultimate guilt, entitlement to immunity or constitutional admissibility. Other preserved appellate grounds remain. Ianniello’s separate relief is outside the writ. The controlling rationale is stated in the Opinion of the Court and requires no analysis under Marks.

#### Precedent Treatment and Current-Law Effect

Effective June 19, Rule 804(b)(1)’s requirements of opportunity and similar motive apply without the court of appeals’ immunity-based fairness exception. Contradiction through independent evidence alone does not forfeit the objection. These precise trial-admissibility questions were previously unresolved.

White v. Illinois, decided January 15, retains its Confrontation Clause rule keyed to the applicable hearsay exception. United States v. Williams, decided May 4, retains its confined grand-jury disclosure duty and qualified dismissal remedy. Neither decision supplies automatic trial admission; neither is overruled or narrowed. No precedent is overruled. Actual motive, other preserved evidentiary and constitutional grounds, and their consequences for the judgments remain unresolved.

#### Separate Positions Relevant to the Decision

Blackmun joins the Court and explains that similar motive does not mean identical motive. The actual issues and context of questioning govern, with neither a categorical exemption for the prosecution nor automatic admission. He favors remand because the appropriate inquiry was not completed below.

Stone-Zsela concurs in the judgment. He requires the defense to establish the evidentiary conditions without shifting the prosecution’s burden to prove guilt beyond a reasonable doubt. The prosecutor may be investigating the same alleged conspiracy or different issues; actual motive governs. Contradictory independent evidence is not disclosure or adoption of the prior account, and access to material does not make it admissible. He reserves properly preserved independent constitutional objections, other exceptions and the factual motive determination, and preserves independent appellate grounds.

Stevens would affirm. In his view, the same crucial question—Cedar Park’s participation in the alleged Club—gave the Government a similar motive to test the witnesses’ denials. A tactical choice not to use the full examination opportunity does not eliminate that motive. He agrees that genuinely different issues can defeat similarity; his conclusion that similarity is established here does not control.

#### Mandate, Remedy, and Stage

Supreme Court review of this merits event is complete. On the ordinary mandate, the Second Circuit must consider the actual-motive arguments under the proper Rule and determine their effect together with the remaining appellate grounds. The Court orders neither categorical exclusion nor unconditional reinstatement of every conviction. It directs no special mandate date, stay, immediate retrial or finding about the truth of either witness’s account. No Supreme Court jurisdiction is retained, and no later filing or result is established.
