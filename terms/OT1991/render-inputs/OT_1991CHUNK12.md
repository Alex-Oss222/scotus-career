# OT1991 — Chunk12 Render Inputs

## Chunk metadata

- Task: Run October Term1991, chunk12. Canonical SectionII version1 is approved as written by the current user.
- Input: `briefs/OT_1991CHUNK12.md`; the matching runtime neutral, comparator and Stone sections are verified identical to all30 canonical sections.
- Coverage: ten completed merits events, four on June18 and six on June19,1992, in inventory order. Every event below supplies the Engine’s eleven blocks.
- Entering state: unchanged October7,1991 opening trackers, edition September14,2026; workspace and 97 effective records through June15. The four June18 records became durable before final June19 revalidation. Uncoordinated same-day siblings share their entering baseline.
- End state: 107 ledger records, 106 Court events plus one institutional source; cursor June19 after Salerno. All126 manifest items retained.
- Mode: single conversation; true blindness was unavailable. Private adaptive audits and disclosed recovery belong to the records and are not public render material.
- Stone fallback: Kraft’s independent equal-protection component only; Stone joins the majority’s decision not to reach it after Commerce relief and adds no ground. No other fallback is used.
- Render forms: full for all ten events, on the individual bases supplied below.
- Stopped matters / Simulation Workflow Blockers: none. Unreviewed source types are identified as read limits in their event notes; no missing item prevents the supplied decision or its rendering.
- Carry-forward matters: Wyoming implementation and Coleman petition No.91-8336 remain open on their existing conditions. No new retained Supreme Court matter.
- Public render: not produced by this Run task. Source cutoffs: June18 or June19,1992, as specified per event; no later external sequel admitted.

### Record index

| Effective date | Event | Canonical record |
|---|---|---|
| 1992-06-18 | Nordlinger v. Hahn | [Record](../records/Nordlinger_v_Hahn_merits_1992-06-18.md) |
| 1992-06-18 | Georgia v. McCollum | [Record](../records/Georgia_v_McCollum_merits_1992-06-18.md) |
| 1992-06-18 | Kraft General Foods, Inc. v. Iowa Department of Revenue and Finance | [Record](../records/Kraft_General_Foods_Inc_v_Iowa_Department_of_Revenue_and_Finance_merits_1992-06-18.md) |
| 1992-06-18 | Gade v. National Solid Wastes Management Association | [Record](../records/Gade_v_National_Solid_Wastes_Management_Association_merits_1992-06-18.md) |
| 1992-06-19 | Forsyth County v. Nationalist Movement | [Record](../records/Forsyth_County_v_Nationalist_Movement_merits_1992-06-19.md) |
| 1992-06-19 | New York v. United States | [Record](../records/New_York_v_United_States_merits_1992-06-19.md) |
| 1992-06-19 | Wisconsin Department of Revenue v. William Wrigley, Jr., Co. | [Record](../records/Wisconsin_Department_of_Revenue_v_William_Wrigley_Jr_Co_merits_1992-06-19.md) |
| 1992-06-19 | American National Red Cross v. S. G. | [Record](../records/American_National_Red_Cross_v_S_G_merits_1992-06-19.md) |
| 1992-06-19 | Wright v. West | [Record](../records/Wright_v_West_merits_1992-06-19.md) |
| 1992-06-19 | United States v. Salerno | [Record](../records/United_States_v_Salerno_merits_1992-06-19.md) |
...
No. 90-1912; October Term1991. Argued 1992-02-25; decided June18,1992. On writ of certiorari to: California Court of Appeal, Second Appellate District, 225 Cal. App. 3d 1259, 275 Cal. Rptr. 684 (December 3, 1990), affirming dismissal without leave to amend; California Supreme Court review denied February 28, 1991.

Whether California’s acquisition-value property-tax assessment scheme and the challenged over-55 replacement-residence and parent-child reassessment exceptions deny Nordlinger equal protection, and whether she may invoke absent travelers’ rights for heightened review. This is a record-grounded formulation, not a purported verbatim petition quotation.

Nordlinger bought a Los Angeles home after renting locally and alleges that she pays approximately five times the tax paid by longer-term owners of comparable nearby homes. California caps the rate and annual assessment growth and generally reassesses upon transfer or new construction, subject to the specified exceptions. These disparities are accepted at the pleading stage; they result from the enacted acquisition-value policy. She alleges no personal interference with interstate movement. The requested relief was a declaration and tax refund, not a completed claim by an interstate traveler.

Render form: full. Basis: Although the judgment is 8–1, Stone-Zsela’s separate judgment concurrence supplies no formal join to the historical Chief Justice’s rationale; the controlling opinion coalition is different. Full form preserves the partial joins and independently sufficient grounds.

## 2. Participation

All nine participate at argument and decision: Stone-Zsela, White, Blackmun, Stevens, O'Connor, Scalia, Kennedy, Souter, Thomas. No case-specific nonparticipation is established; all arguments follow Thomas’s October23,1991 oath.

## 3. Public Action

Affirmed. No proper traveler’s claim, independent statutory tax objection, discriminatory administration contrary to the adopted system, or alternative ability-to-pay/revenue-stability justification is decided. The Court does not decide state timeliness under Revenue and Taxation Code §4808; it resolves the federal ground on which the state appellate court ruled.

## 4. Judgment & Remedy

| Judgment component | Disposition | Supporting Justices | Opposing Justices | Remedy or remand |
|---|---|---|---|---|
| Rejection of Nordlinger’s own equal-protection challenge and requested tax relief | Affirmed, 8–1 | Stone-Zsela, White, Blackmun, O'Connor, Scalia, Kennedy, Souter, Thomas | Stevens | Dismissal without leave to amend stands; no refund or redesigned tax schedule is ordered. |
| Refusal to entertain absent travelers’ claims | Claim not reached on behalf of absent travelers; seven join Blackmun’s threshold ruling and Stone states the same refusal separately | Blackmun, White, O'Connor, Scalia, Kennedy, Souter, Thomas, Stone-Zsela | None; see reservation | Stevens does not decide this issue because he would reverse on ordinary equal protection; no contrary travel judgment is attributed to him. |

## 5. Opinion Topology

| Writing | Author | Joined by | Relationship to judgment | Scope joined |
|---|---|---|---|---|
| Opinion of the Court | Blackmun | White, O'Connor, Scalia, Kennedy, Souter; Thomas: Part II-A only | Affirmance | All holdings and judgment; Thomas joins only the third-party travel ruling (Part II-A). |
| Concurrence in part and in the judgment | Thomas | None | Affirmance | Joins Blackmun’s Part II-A only; independently accepts rationality but rejects the distinction of Allegheny Pittsburgh. |
| Concurrence in the judgment | Stone-Zsela | None | Affirmance | Separate predictability/continuity, exception and absent-traveler grounds; no formal joins. |
| Dissent | Stevens | None | Reversal | Would reverse on rational-basis grounds; does not reach travelers’ rights. |
...
Thomas concurs in the judgment and joins only the travel ruling. He accepts rationality but finds the Court's distinction of Allegheny Pittsburgh unpersuasive and risking confusion of state-law error with equal protection; that criticism does not overrule it. Stevens dissents because the permanent acquisition and family preferences lack adequate fit with an impartial public purpose; he would reverse even under rational-basis review. Stone-Zsela separately concurs on the predictability/continuity and exception grounds, preserving proper travel and discriminatory-administration claims.

## 10. Procedure After Action

Supreme Court merits review is complete. Ordinary mandate leaves dismissal without leave to amend in place. The Court awards no refund, orders no reassessment or replacement schedule, and retains no implementation proceeding. No mandate-issuance date, later filing or independent traveler’s action is established.

## 11. Source Notes

[Official United States Reports, 505 U.S. 1](https://www.govinfo.gov/content/pkg/USREPORTS-505/pdf/USREPORTS-505-1.pdf) supplies the case identity, dates and reported record. [Judgment below](https://static.case.law/cal-app-3d/225/html/1259-01.html) supplies the lower proceedings and judgment. Questions above are record-grounded formulations. Research cutoff: June18,1992. No later proceedings or external consequences are established.
...
No. 91-372; October Term1991. Argued 1992-02-26; decided June18,1992. On writ of certiorari to: Supreme Court of Georgia, 261 Ga. 473, 405 S.E.2d 688 (July 12, 1991), affirming the certified interlocutory denial of the prosecution’s pretrial motion; reconsideration denied July 24, 1991.

Whether criminal defendants’ purposeful racial peremptory strikes are state action, whether the State may assert excluded jurors’ equal-protection rights, and whether that restriction is consistent with defense protections. This is a record-grounded formulation, not a purported verbatim petition quotation.

White defendants face assault and battery charges arising from an alleged attack on African-American victims. The prosecution sought a pretrial ruling requiring race-neutral explanations if it later established a prima facie case of discriminatory defense strikes. The trial court denied the request as legally unavailable. No strike, finding of discriminatory intent, verdict or conviction is adjudicated in this event.

Render form: full. Basis: The 7–2 judgment includes separate judgment-only writings and a five-Justice Court opinion with a different controlling coalition after Stone’s separate concurrence. Full form preserves the authority and attribution limits.
...
Reversed and remanded. No strike or purposeful discrimination is found. The criminal charges, a particular privilege dispute, nonracial classifications and proposed unconscious-bias safeguards remain undecided. The rule neither abolishes peremptories nor constitutionalizes every private act of defense counsel.

## 4. Judgment & Remedy

| Judgment component | Disposition | Supporting Justices | Opposing Justices | Remedy or remand |
|---|---|---|---|---|
| Availability of a prohibition on purposeful racial defense peremptories and supported State objections | Reversed and remanded, 7–2 | Stone-Zsela, White, Blackmun, Stevens, Kennedy, Souter, Thomas | O'Connor, Scalia | Jury selection must follow the constitutional prohibition and ordinary Batson burdens; no finding of a discriminatory strike is made. |
...
| Concurrence in the judgment | Thomas | None | Reversal and remand | Edmonson controls its consequences despite his first-impression state-action objection; no formal join to Blackmun. |
| Concurrence in the judgment | Stone-Zsela | None | Reversal and remand | Act-specific attribution, State standing and unchanged Batson procedure; concrete privilege question reserved; no formal joins. |
| Dissent | O'Connor | None | Affirmance | Criminal-defense peremptories remain private under Polk County despite Edmonson’s civil rule. |
| Dissent | Scalia | None | Affirmance | Edmonson logically applies but should not be extended from its erroneous premise; no formal join to O’Connor. |
...
Thomas accepts Edmonson’s controlling consequences but questions its state-action premise and the costs of restricting defense peremptories. O’Connor would treat criminal-defense selection as private representation under Polk County; Scalia considers Edmonson logically applicable but rejects its underlying rule. Stone-Zsela separately supports limited attribution and the ordinary Batson procedure, reserving concrete privilege questions.
...
[Official United States Reports, 505 U.S. 42](https://www.govinfo.gov/content/pkg/USREPORTS-505/pdf/USREPORTS-505-42.pdf) supplies the case identity, dates and reported record. [Judgment below](https://static.case.law/ga/261/html/0473-01.html) supplies the lower proceedings and judgment. Questions above are record-grounded formulations. Research cutoff: June18,1992. No later proceedings or external consequences are established.
...
No. 90-1918; October Term1991. Argued 1992-04-22; decided June18,1992. On writ of certiorari to: Supreme Court of Iowa, 465 N.W.2d 664 (February 20, 1991), affirming the challenged deficiency and rejecting Commerce and equal-protection claims; reconsideration denied March 19, 1991.

Whether Iowa’s taxation of foreign-subsidiary dividends while deducting equivalent domestic-subsidiary dividends violates the Foreign Commerce Clause. The accepted unitary relationship and general authority to apportion connected income are not disputed. This is a record-grounded formulation, not a purported verbatim petition quotation.

Kraft’s 1981 Iowa return deducted dividends from six foreign-incorporated subsidiaries operating abroad. Iowa used the federal taxable-income base with adjustments, deducted domestic dividends, and did not grant the federal foreign-tax credit. The resulting deficiency is challenged. The relevant comparison concerns subsidiaries without independent Iowa operations, not a subsidiary whose own Iowa business supplies a separate taxing basis.

Render form: full. Basis: Full form is selected to display the 8–1 result, distinct separate writings and equal-protection nonreach component. Stone’s replacement of the historical Chief Justice changes only the margin; it does not change the disposition or the seven-Justice controlling coalition.
...
Reversed and remanded. Independent international multiple-taxation and national-voice theories, the equal-protection challenge, nondiscriminatory unitary taxation and remedial calculations remain undecided. No blanket immunity for foreign dividends, change to Allied-Signal’s accepted nexus boundary or mandatory adoption of the entire federal code follows.

## 4. Judgment & Remedy

| Judgment component | Disposition | Supporting Justices | Opposing Justices | Remedy or remand |
|---|---|---|---|---|
| Foreign-commerce challenge to the discriminatory assessment | Reversed and remanded, 8–1 | Stone-Zsela, White, Stevens, O'Connor, Scalia, Kennedy, Souter, Thomas | Blackmun | Further state tax proceedings must supply a constitutionally adequate nondiscriminatory result; no dollar amount or mandated tax-code rewrite. |
| Independent equal-protection challenge | Not reached after Commerce relief | Stevens, White, O'Connor, Scalia, Kennedy, Souter, Thomas, Stone-Zsela | Blackmun | Blackmun would reject this claim on its merits in affirming. Stone’s standing fallback covers only concurrence in the majority’s nonreach disposition, without a new ground. |

## 5. Opinion Topology

| Writing | Author | Joined by | Relationship to judgment | Scope joined |
|---|---|---|---|---|
| Opinion of the Court | Stevens | White, O'Connor, Scalia, Kennedy, Souter, Thomas | Reversal and remand | Both controlling propositions and reversal/remand; equal-protection claim not reached. |
| Concurrence in the judgment | Stone-Zsela | None | Reversal and remand | Separate foreign-commerce discrimination ground; no formal join, remedial calculations reserved. |
| Dissent | Blackmun | None | Affirmance | Facial-challenge/overall-tax-burden objection and rational administrative conformity; would reject both constitutional claims. |
...
Effective June 18, the specific domestic/foreign dividend distinction is invalid. Nondiscrimination extends beyond favoritism solely to the taxing State; neither compelled reorganization, partial federal conformity, convenience with reasonable neutral alternatives, nor hypothesized outside taxes saves this measure. Accepted unitary nexus and the independent foreign-commerce branches remain separate. No precedent is overruled.

## 9. Separate Writings

Blackmun dissents. He regards the facial challenge as insufficiently supported without an overall comparison of domestic and foreign tax burdens, concludes the record does not establish systematic disadvantage, and would also reject equal protection because administrative conformity is rational. Stone-Zsela separately agrees that Iowa’s actual source distinction lacks an adequate justification and leaves calculations to the state proceedings.

## 10. Procedure After Action

Supreme Court merits review ends with reversal and remand. The Iowa courts must provide further tax proceedings consistent with the nondiscrimination holding and applicable due-process remedial requirements. The Court awards no refund amount, orders no particular comprehensive tax-code revision and creates no retained Supreme Court docket, later filing or mandate-issuance date.

## 11. Source Notes

[Official United States Reports, 505 U.S. 71](https://www.govinfo.gov/content/pkg/USREPORTS-505/pdf/USREPORTS-505-71.pdf) supplies the case identity, dates and reported record. [Judgment below](https://static.case.law/nw2d/465/html/0664-01.html) supplies the lower proceedings and judgment. Questions above are record-grounded formulations. Research cutoff: June18,1992. No later proceedings or external consequences are established.
...
No. 90-1676; October Term1991. Argued 1992-03-23; decided June18,1992. On writ of certiorari to: United States Court of Appeals for the Seventh Circuit, National Solid Wastes Management Association v. Killian, 918 F.2d 671 (November 14, 1990), operative judgment vacating and remanding the district disposition; rehearing denied January 29, 1991. The rule rejected nonapproved direct, clear and substantial occupational regulation. The court expressly condemned the 4,000-hour requirement and left the unappealed district invalidation of within-Illinois training undisturbed.

Whether OSH Act §18 automatically displaces Illinois hazardous-waste worker training and licensing standards on an issue covered by a federal standard whenever Illinois lacks an approved state plan, including rules that also protect the public. This is a record-grounded formulation, not a purported verbatim petition quotation.

OSHA’s hazardous-waste training standards include initial instruction, supervised experience, certification and refresher requirements. Illinois requires licensing, training, examination and, for equipment operators, 4,000 hours of experience, for worker and public protection. Illinois has no approved §18 plan. The lower court’s direct-and-substantial overlap rule went beyond the district court’s purpose-based approach. The record lacks a completed provision-by-provision determination under the rule adopted here.

Render form: full. Basis: Required: 5–4 judgment, changed disposition and controlling law, and no complete Opinion of the Court. Full complex form must preserve the limited five-Justice proposition and unresolved broader rationale.
...
| Judgment component | Disposition | Supporting Justices | Opposing Justices | Remedy or remand |
|---|---|---|---|---|
| Categorical preemption solely from occupational overlap and lack of an approved state plan | Reversed, 5–4; remanded | Stone-Zsela, Blackmun, Stevens, Souter, Thomas | White, O'Connor, Scalia, Kennedy | Examine the challenged provisions under the shared rejection of automatic displacement; preserve independently supported and unappealed rulings; no wholesale enforcement or invalidation. |

## 5. Opinion Topology

| Writing | Author | Joined by | Relationship to judgment | Scope joined |
|---|---|---|---|---|
| Plurality opinion announcing the judgment | Souter | Blackmun, Stevens, Thomas | Reversal and remand | Rejects automatic displacement; would permit concurrent state standards whenever compliance with both sovereigns’ requirements is physically possible. |
| Concurrence in the judgment | Stone-Zsela | None | Reversal and remand | Rejects automatic overlap preemption; permits demonstrated conflict or a clearly enacted exclusive scheme/ceiling; no formal join to Souter. |
| Dissent | O'Connor | White, Scalia | Affirmance | Section18’s integrated plan scheme implies exclusive regulation of covered issues; dual purpose does not avoid it. |
| Dissent | Kennedy | None | Affirmance | Section18’s text and structure expressly require an approved plan for covered occupational standards; rejects generalized obstacle analysis. |
...
Effective June18, an approved plan is not the automatic prerequisite to every compatible supplementary state occupational standard solely because a federal standard exists. The categorical lower rule is displaced, and provision-specific review remains. No five-Justice opinion adopts a complete replacement test for conflict: Souter’s impossibility-only account remains noncontrolling, while surviving pre-divergence conflict principles are not overruled. Actual statutory ceilings, exclusivity, savings and proved incompatibility must be respected on their own terms.

## 9. Separate Writings

Souter, joined by Blackmun, Stevens and Thomas, would allow concurrent regulation whenever compliance with both sets of requirements is physically possible. Stone-Zsela concurs in reversal but preserves displacement grounded in demonstrated conflict or a clearly enacted federal ceiling or exclusive arrangement. O’Connor, joined by White and Scalia, would affirm because the integrated state-plan scheme excludes unapproved regulation of covered issues. Kennedy separately would affirm on the statute’s express structure while rejecting a broad judicial inference of conflict from duplication.
...
[Official United States Reports, 505 U.S. 88](https://www.govinfo.gov/content/pkg/USREPORTS-505/pdf/USREPORTS-505-88.pdf) supplies the case identity, dates and reported record. [Judgment below](https://static.case.law/f2d/918/html/0671-01.html) supplies the lower proceedings and judgment. Questions above are record-grounded formulations. Research cutoff: June18,1992. No later proceedings or external consequences are established.
...
October Term 1991; merits decision June 19, 1992; argued March 31, 1992. No. 91-538. Certiorari to the Eleventh Circuit, 913 F.2d 885 and 934 F.2d 1482, which reversed the District Court's rejection of the County facial fee challenge on a nominal-fee theory. The Court reviews whether that fee mechanism violates the First Amendment, including the asserted nominal ceiling and the independently pleaded licensing defects. The Movement seeks injunctive protection against enforcement. The distinct City and School Board permit controversies are outside this review. Render form: full. Basis: Stone-Zsela supports affirmance on a separate writing, changing the historical judgment coalition and opinion topology; compact-form historical equivalence is not satisfied.

## 2. Participation

Chief Justice Stone-Zsela and Justices White, Blackmun, Stevens, O'Connor, Scalia, Kennedy, Souter, and Thomas participated at argument and decision. No nonparticipation is established. Nine participated; the six-Justice quorum and five-vote merits threshold are satisfied.

## 3. Public Action

The Court affirms the judgment invalidating the County's challenged fee mechanism, on its unbounded discretion and content-dependent costs. It rejects a universal nominal-fee ceiling.

## 4. Judgment & Remedy

| Component | Disposition and coalition | Remedy and stage |
|---|---|---|
| County fee mechanism | Affirm, 6–3: Stone-Zsela, Blackmun, Stevens, O'Connor, Kennedy, Souter. White, Scalia, Thomas would reverse the nominal-only basis and remand the other claims. | Facial relief against enforcement of this fee mechanism stands; proceedings below implement the affirmed judgment. No damages, refund amount, or mandatory municipal spending formula is awarded. |

The County remains free to adopt lawful neutral coordination rules and a sufficiently bounded cost policy. The Court does not resolve the City or School Board claims, prescribe a fee amount, or adjudicate indigency relief. Supreme Court merits review is complete; ordinary mandate implementation remains below.

## 5. Opinion Topology

| Writing | Author | Formal joins and authority | Judgment relationship |
|---|---|---|---|
| Opinion of the Court | Blackmun | Stevens, O'Connor, Kennedy, Souter join all; five Justices | Affirms; both facial grounds independently control; rejects amount-only rule |
| Concurrence in the judgment | Stone-Zsela | No joins; no formal join in another writing | Affirms on bounded licensing and content-neutrality grounds; compatible independent support |
| Dissent | White | Scalia and Thomas join all; three Justices | Would reverse nominal-only rule and remand the remaining facial grounds |
...
The fee mechanism cannot be enforced against protected demonstrations. Both unbounded expressive-licensing discretion and hostility-based permit pricing independently support that result. A cap cures neither defect, and nonnominal fees remain permissible if otherwise lawful. Cox, Lakewood, and received content-neutrality doctrine continue with the precise applications above. No precedent is overruled. No Marks analysis is required because a five-Justice opinion controls each holding. Concrete indigency rules, fixed neutral fees, content-independent administrative costs, and municipal funding duties remain outside the decision.

## 9. Separate Writings

White, joined by Scalia and Thomas, would correct the Court of Appeals' nominal-fee rule under Cox and remand the other challenges for initial lower-court findings. The dissent does not approve fees based on hostile audiences or unlimited discretion; it disputes the propriety of resolving those defects on this review. Stone-Zsela concurs in the judgment, applying the same facial and neutrality rules without regard to the speaker's viewpoint, and reserves concrete indigency, fixed neutral fees, and municipal spending questions. His concurrence adds no formal join to the Court opinion.

## 10. Procedure After Action

Affirmance of the County portion leaves the facial protection in place and returns implementation to the lower courts through the ordinary mandate. No further Supreme Court merits act is ordered, and no separate review of the City or School Board controversy is added. No roster, circuit allotment, institutional practice, or linked docket changes follow.

## 11. Source Notes

Research cutoff: June 19, 1992. [Official report, 505 U.S. 123–143](https://tile.loc.gov/storage-services/service/ll/usrep/usrep505/usrep505123/usrep505123.pdf), read in full including footnotes and dissent, supplies argument/decision dates, scope, record facts. [Panel judgment, 913 F.2d 885](https://law.resource.org/pub/us/case/reporter/F2/913/913.F2d.885.89-8417.html) and [en banc judgment, 934 F.2d 1482](https://law.resource.org/pub/us/case/reporter/F2/934/934.F2d.1482.89-8417.html), both read in full, supply the judgment below. [Cox official report](https://tile.loc.gov/storage-services/service/ll/usrep/usrep312/usrep312569/usrep312569.pdf) and [Lakewood official report](https://tile.loc.gov/storage-services/service/ll/usrep/usrep486/usrep486750/usrep486750.pdf) were read in full. [Archive docket item](https://archive.org/details/micro_IA40385013_0189) and its full docket OCR corroborate route and scheduling; an OCR entry says argued March 30 while the official report and scheduled date say March 31, so the official report governs. No claim is made to have read the separately indexed briefs or transcript.
...
October Term 1991; merits decision June 19, 1992; argued March 30, 1992. Consolidated No. 91-543, New York v. United States et al.; No. 91-558, County of Allegany, New York v. United States et al.; and No. 91-563, County of Cortland, New York v. United States et al. Certiorari to the Second Circuit, 942 F.2d 114, affirming the District Court's rejection of constitutional challenges to the 1985 Low-Level Radioactive Waste Policy Amendments Act. The lower court treated the evidentiary dismissal as summary judgment. The State and counties seek declaratory relief under the Tenth Amendment and Guarantee Clause against the monetary, access, and take-title provisions, with severability at issue. Due process and Eleventh Amendment claims are abandoned. Render form: full. Basis: component-specific joins, a five-Justice controlling opinion outside the incentive sections, and Stone-Zsela's distinct published resolution of limited Guarantee justiciability require explicit topology; the historical six-Justice full-opinion coalition is not reproduced.
...
The Court affirms each docket's judgment as to the monetary and access incentives and the remaining Guarantee Clause claim, reverses as to the compulsory take-title mechanism, severs that mechanism, and remands for corresponding declaratory relief.

## 4. Judgment & Remedy

| Component, in all three dockets | Disposition and named coalition | Remedy or limit |
|---|---|---|
| Monetary incentives | Affirm, 9–0: Stone-Zsela, White, Blackmun, Stevens, O'Connor, Scalia, Kennedy, Souter, Thomas | Lawful surcharge collection and distributions remain operative |
| Access incentives | Affirm, 9–0: Stone-Zsela, White, Blackmun, Stevens, O'Connor, Scalia, Kennedy, Souter, Thomas | Authorized higher costs and exclusion remain operative; no duty on other States to accept New York waste |
| Compulsory title, possession, and associated liability | Reverse, 6–3: Stone-Zsela, O'Connor, Scalia, Kennedy, Souter, Thomas; White, Blackmun, Stevens would affirm | Declare the compulsory mechanism invalid |
| Severance and corresponding remand | Preserve remainder and remand, 6–3: Stone-Zsela, O'Connor, Scalia, Kennedy, Souter, Thomas; White, Blackmun, Stevens would preserve the entire Act by affirming | Sever the compulsory mechanism; no federal replacement program |
| Remaining Guarantee Clause challenge | Reject, 9–0 in result: Stone-Zsela, White, Blackmun, Stevens, O'Connor, Scalia, Kennedy, Souter, Thomas | Five-Justice Court opinion assumes justiciability; Stone-Zsela alone separately decides this limited claim is justiciable; no majority adopts that reach |

The responsibility clause creates no additional freestanding command. Supreme Court merits review is complete; the lower courts implement declaratory relief on remand. The decision does not revive abandoned claims, decide actual compact obligations, or fix a new funding-coercion percentage.

## 5. Opinion Topology

| Writing | Author | Formal joins and authority | Judgment relationship |
|---|---|---|---|
| Opinion of the Court, all parts | O'Connor | Scalia, Kennedy, Souter, Thomas join all; five Justices | Divided disposition; controls construction, structural invalidation, limited Guarantee merits, and severance |
| Same opinion, Parts III-A and III-B only | O'Connor | White, Blackmun, Stevens additionally join these monetary/access sections; eight Justices total in these sections | Affirms those incentives |
| Concurrence in the judgment | Stone-Zsela | No joins; no formal join of another writing | Same divided disposition; affirmatively reaches only the limited institutional Guarantee claim, then rejects it |
| Opinion concurring in part and dissenting in part | White | Blackmun and Stevens join all | Would affirm the entire scheme; joins Court only in III-A and III-B |
| Opinion concurring in part and dissenting in part | Stevens | No joins | Same affirm-all position; additionally defends broader congressional power to issue state-directed commands |
...
The monetary and access mechanisms continue. The compulsory title, possession, and liability mechanism is invalid and severed. The general responsibility language does not independently compel regulation. Congress retains direct authority over the interstate disposal market, authorized conditional spending, and lawful cooperative arrangements; Garcia's generally applicable regulation of state activity is retained. This decision clarifies and extends Hodel's structural limitation to the unavoidable choice between state administration and compulsory ownership of private waste. Actual compact duties, direct regulation of State market conduct, and independently authorized state-court or judicial duties remain distinct. The Guarantee Clause claim fails, but general justiciability remains open because Stone-Zsela's affirmative reach is not the Court's rule. Alaska Airlines is applied without revision. No Marks extraction is needed: every controlling holding has at least five formal Court-opinion adherents.

## 9. Separate Writings

Stone-Zsela concurs in the judgment without formally joining the Court opinion. He agrees that the monetary and access terms leave lawful choices, that compulsory ownership and administration exceed ordinary commerce authority, and that severance preserves the statute. He separately finds this limited institutional Guarantee claim judicially manageable under Baker because it asks whether state legislative choice has been displaced, then rejects it on the merits; he reserves other Guarantee theories and does not add a Guarantee ground for invalidating take-title. That affirmative justiciability position is noncontrolling. White, joined by Blackmun and Stevens, would uphold the whole negotiated arrangement: New York's participation and benefits, Garcia's political safeguards, and FERC's cooperative framework support the bargain, which they consider an interstate agreement New York should honor. Stevens additionally argues that the Constitution's enlargement of federal power did not prohibit directions to States; his broader command theory is his own. Neither dissenting theory controls.

## 10. Procedure After Action

Remand in each consolidated docket for declaratory relief corresponding to the invalidity and severance of the compulsory title, possession, and liability mechanism. The otherwise operative financing and access scheme remains. No damages award, disposal site, federal administrator, or compulsory acceptance obligation for another State is ordered. No new compact adjudication or abandoned constitutional claim is brought up. No roster, institutional practice, circuit allotment, or other-case proceeding changes.

## 11. Source Notes

Research cutoff: June 19, 1992. [Official report, 505 U.S. 144–213](https://tile.loc.gov/storage-services/service/ll/usrep/usrep505/usrep505144/usrep505144.pdf), read in full including both separate opinions and footnotes, supplies consolidated captions, dates, the quoted statutory language, and review scope. [Second Circuit judgment, 942 F.2d 114](https://law.resource.org/pub/us/case/reporter/F2/942/942.F2d.114.91-6035.91-6033.91-6031.1511.1513.html), read in full, supplies posture and material record. [Archive lead docket](https://archive.org/details/micro_IA40385013_0191) and [Cortland docket](https://archive.org/details/micro_IA40385013_0193) were read in full as OCR and corroborate the three-docket consolidation and March 30 argument. The exact petition questions are not represented as independently verified quotations. Full official predecision reports read: Hodel, FERC, Garcia, Dole, South Carolina v. Baker, Alaska Airlines, and the separately paginated Abbott Laboratories report. Other older authorities are relied on within the passages reproduced in those reports and the official report, not represented as independently read in full. The Act's mechanism is established by the full lower judgment and official reproduction; no later Code edition substitutes for its enacted text.
...
October Term1991; merits decision; effective June19,1992. Argued January 22, 1992. Historical reporter reference: 505 U.S. 214. On writ of certiorari to the Supreme Court of Wisconsin under 28 U.S.C. §1257. That court, 160 Wis.2d 53, 465 N.W.2d 800 (February 19, 1991), reversed the intermediate court and disallowed the assessed franchise tax under 15 U.S.C. §381.

Question: What activities constitute solicitation of orders under 15 U.S.C. §381(a), and whether Wrigley’s additional Wisconsin activities remove the statutory protection from net-income taxation. This is a record-grounded formulation, not a verbatim petition quotation.

Wisconsin assessed an income-based franchise tax in 1980 for 1973–1978. Wrigley’s local representatives solicited orders approved in Chicago and fulfilled from outside Wisconsin. They also regularly exchanged stale gum, sometimes sold replacement display stock through agency-stock checks, and maintained inventory at home or in reimbursed rented space. Recruitment, training, evaluation, sales meetings and limited mediation of credit disputes accompanied the solicitation. The administrative testimony was accepted as credible. The Wisconsin Supreme Court associated the activities closely with solicitation; it did not resolve penalty interest. No constitutional tax calculation or unrelated defense must be decided to resolve §381 coverage.

Render form: full. Basis: Full form is chosen to preserve O’Connor’s partial join, distinct application and separate sufficient ground, alongside the other judgment-only writing. Compact form is permitted only in eligible cases and is not required.

## 2. Participation

All nine Justices participate at argument and decision: Stone-Zsela, White, Blackmun, Stevens, O’Connor, Scalia, Kennedy, Souter, Thomas. All arguments occur after Thomas’s October23,1991 oath. No case-specific nonparticipation or recusal is established. Six constitute a quorum; five votes are required for judgment or a majority proposition. The nine-member Court, seniority, October23 circuit allotments and standing referral practice continue.

## 3. Public Action

The judgment of the Supreme Court of Wisconsin is reversed, and the case is remanded for further proceedings consistent with the Court’s construction of §381.
...
| Concurrence in the judgment | Stone-Zsela | No additional joiners | Supports reversal and remand. | Independent approved functional construction, combined-activity application and narrow trivial-departure qualification; no formal join in another opinion. |
...
Supreme Court merits review is complete. The case returns to the Wisconsin courts for lawful assessment proceedings consistent with the statutory holding. No new filing, deadline, final tax amount, mandate-issuance date, retained jurisdiction or later lower-court outcome is established.

## 11. Source Notes

[Official United States Reports, 505 U.S. 214](https://tile.loc.gov/storage-services/service/ll/usrep/usrep505/usrep505214/usrep505214.pdf) verifies the argument and decision dates, docket, participation, procedural record and historical writings. [Full judgment below](https://static.case.law/wis-2d/160/cases/0053-01.json) supplies the lower posture, alternative or reserved issues and material record. The official report was read in full. Relevant earlier primary opinions supply the legal authorities identified above. Research cutoff: June19,1992. No later connected proceeding or direct quotation is supplied.
...
October Term1991; merits decision; effective June19,1992. Argued March 3, 1992. Historical reporter reference: 505 U.S. 247. On writ of certiorari to the United States Court of Appeals for the First Circuit under 28 U.S.C. §1254(1). The First Circuit, 938 F.2d 1494 (July 24, 1991), reversed the District Court’s denial of remand on an interlocutory appeal authorized under §1292(b).

Question: Whether the Red Cross charter’s authorization to sue and be sued in state or federal courts confers original federal jurisdiction permitting removal of this state-law action. This is a record-grounded formulation, not a verbatim petition quotation.

S. G. and her husband alleged that blood supplied by the Red Cross caused an HIV infection during surgery. Their state-law action against the Red Cross was removed before the state court decided consolidation with actions against the surgeon’s estate and equipment manufacturer. The Red Cross invoked both charter jurisdiction and diversity. The District Court denied remand and certified the charter issue for interlocutory review. The First Circuit rejected special jurisdiction but left the proposed joinder, which could defeat diversity, for further consideration; it did not itself establish that every independent federal basis was absent. Its opinion also left the alternative complaint-rule and abstention arguments unresolved. The historical allegations establish no contamination, negligence, causation or damages finding.

Render form: full. Basis: The final decision includes a six-vote judgment, a five-Justice Court opinion, a judgment-only concurrence and a dissent; full form preserves the exact authority and scope of the writings.
...
The judgment of the First Circuit is reversed, and the case is remanded for further proceedings consistent with the charter’s grant of original federal jurisdiction.
...
| Writing | Author | Joined by | Relationship to judgment | Scope joined |
|---|---|---|---|---|
| Opinion of the Court | Souter | White, Blackmun, Stevens, Thomas | Supports reversal and remand. | Entire opinion: special charter jurisdiction, independent removal ground and ArticleIII authority. |
...
| Dissent | Scalia | O’Connor, Kennedy | Would affirm the First Circuit’s charter ruling and preserve its conditional diversity/joinder posture. | Entire dissent on the charter’s capacity-only meaning; does not reach ArticleIII. |
...
Effective June19,1992, the charter itself provides original federal jurisdiction and a §1441 removal basis for this Red Cross action; a §1331 federal claim is not required. ArticleIII permits that specific grant. Section1349’s general incorporation limitation and ordinary capacity-only precedents remain, with the nonstock question unresolved. Federal jurisdiction does not create federal substantive tort law, immunity or liability. Other charter language, diversity, joinder, and independently available abstention are reserved.

## 9. Separate Writings

Scalia, joined by O’Connor and Kennedy, reads the clause as granting corporate capacity only: its symmetric state/federal wording and place in the list of powers differ from Osborn, while D’Oench contained express arising-under language. They would preserve the First Circuit’s conditional remand posture and do not reach ArticleIII. Stone-Zsela’s judgment concurrence confines its reasoning to this charter’s explicit federal reference in its established legal context and reserves different wording, alternative removal grounds, immunity and substantive law.

## 10. Procedure After Action

Supreme Court review of the charter issue is complete. The case returns through the First Circuit for federal proceedings consistent with the charter jurisdiction holding and for unresolved matters properly available below. No tort findings, damages, new filing, deadline, mandate-issuance date or retained Supreme Court supervision are established.

## 11. Source Notes

[Official United States Reports, 505 U.S. 247](https://tile.loc.gov/storage-services/service/ll/usrep/usrep505/usrep505247/usrep505247.pdf) verifies the argument and decision dates, docket, participation, procedural record and historical writings. [Full judgment below](https://static.case.law/f2d/938/cases/1494-01.json) supplies the lower posture, alternative or reserved issues and material record. The official report was read in full. Relevant earlier primary opinions supply the legal authorities identified above. Research cutoff: June19,1992. No later connected proceeding or direct quotation is supplied.
...
October Term1991; merits decision; effective June19,1992. Argued March 24, 1992. Historical reporter reference: 505 U.S. 277. On writ of certiorari to the United States Court of Appeals for the Fourth Circuit under 28 U.S.C. §1254(1). That court, 931 F.2d 262 (April29,1991, amended June21,1991), reversed the District Court’s denial of habeas relief on the insufficiency claim and remanded for a writ.

Question: Whether the trial evidence was constitutionally sufficient to sustain West’s larceny conviction on federal habeas review, and whether the proposed Teague-based framework changes review of state applications of federal law. The Court’s additional-briefing question addressed deference to state determinations applying law to particular facts. The phrasing here is record-grounded, not a verbatim petition quotation.

Police recovered more than 15 distinctive items stolen from Cardova’s home in West’s residence two to four weeks after the theft. West’s trial account of buying and selling at flea markets was confused, incomplete and uncorroborated, and left major items unexplained. A prior felony was available for credibility, not independent propensity proof of this theft. Virginia’s grand-larceny threshold at the offense was $100, not the later $200 figure. The instructions retained the State’s burden to prove every element beyond a reasonable doubt while permitting an inference from unexplained or falsely explained recent possession. Direct and state collateral review rejected insufficiency; the federal District Court rejected that claim and a distinct new-evidence claim based on Elkins’s later statement. The Fourth Circuit applied contextual considerations drawn from Cosby and found the record insufficient, leaving the Elkins claim unaddressed. The exhausted Jackson claim challenges this record, not the facial validity of every possession inference or an independently preserved jury-instruction claim.

Render form: full. Basis: The judgment is unanimous but no complete opinion commands a majority; distinct merits and Teague grounds and judgment-only writings require full form.
...
The judgment of the Fourth Circuit is reversed, and the case is remanded for further proceedings. Habeas relief on the record-based Jackson insufficiency claim is rejected.

## 4. Judgment & Remedy

| Judgment component | Disposition and vote | Supporting Justices | Opposing Justices | Remedy or remand |
|---|---|---|---|---|
| Exhausted Jackson insufficiency ground | Reversed and remanded, 9–0 | Stone-Zsela, White, Blackmun, Stevens, O’Connor, Scalia, Kennedy, Souter, Thomas | No opposing Justice | The Fourth Circuit’s insufficiency-based direction to issue the writ cannot stand. The separate new-evidence claim left undecided by that court remains for its own lawful disposition on remand. No new trial, acquittal, expansion of custody, disposition of every habeas claim or future filing is ordered. |

## 5. Opinion Topology

| Writing | Author | Joined by | Relationship to judgment | Scope joined |
|---|---|---|---|---|
| Opinion announcing the judgment | Thomas | Scalia | Supports reversal and remand on evidentiary sufficiency. | Entire principal opinion. Applies Jackson to this evidence and reserves selection of a broad legal-review standard; its historical/deference discussion has no majority join. |
| Concurrence in the judgment | White | No additional joiners | Supports reversal and remand on evidentiary sufficiency. | Expressly adopts the principal opinion’s record-specific Jackson sufficiency demonstration; no formal join in its other reasoning. |
| Concurrence in the judgment | O’Connor | Blackmun, Stevens | Supports reversal and remand on evidentiary sufficiency. | Entire concurrence: sufficient evidence under Jackson; rejects the suggestion that Teague itself replaces independent review of existing federal law. |
| Concurrence in the judgment | Kennedy | No additional joiners | Supports reversal and remand on evidentiary sufficiency. | Entire concurrence: Jackson sufficiency; retroactivity and independent mixed-question review are distinct. Reserves whether this particular requested application would be new. |
| Concurrence in the judgment | Souter | No additional joiners | Supports reversal and remand on the threshold new-rule ground. | Teague-only ground: the specific postfinality restriction on the established falsely-explained-possession inference is new. Does not reach the merits as a ground or join the sufficiency proposition. |
| Concurrence in the judgment | Stone-Zsela | No additional joiners | Supports reversal and remand on evidentiary sufficiency. | Independent Jackson application with the approved possession-plus-credibility, burden and propensity limits; no formal join in another opinion and no broad new review standard. |

No complete opinion commands a majority. The narrow proposition identified in Holdings is expressly adopted across the designated separate writings; formal joins and judgment votes remain distinct.
...
The existing Jackson standard is applied without a new burden, proof quantum, presumption, corroboration requirement or categorical possession-to-theft rule. The narrow sufficiency application has eight express supporters, although no complete opinion has five joins. Teague and its existing exceptions, Miller’s legal/fact distinction, and the then-existing §2254(d) remain; the Court adopts no general reasonable-state-decision rule. The separate writings disagree over Teague sequencing and its application here. Souter’s new-rule ground has no controlling coalition. O’Connor, Blackmun, Stevens and Kennedy’s broader independent-review discussion is not converted into a new general holding by Stone’s narrower approved position. Marks supplies no common rationale combining a Teague bar with a merits denial. The alternative Elkins claim remains undecided.

## 9. Separate Writings

Thomas, joined by Scalia, finds the trial evidence sufficient whatever the ultimate answer to the proposed broader review question and leaves that choice open. White endorses the Jackson application. O’Connor, joined by Blackmun and Stevens, and Kennedy separately explain that Teague’s retroactivity inquiry does not itself replace independent application of existing federal law. Kennedy reserves whether this particular Jackson claim would require a new rule because it already fails on the merits. Souter would stop at Teague: the later restriction imposed on the established inference from falsely explained recent possession was not dictated when the conviction became final. Stone-Zsela applies Jackson independently, limits disbelief to its proper role alongside affirmative evidence, preserves the State’s burden and rejects using the prior felony as propensity proof; he finds no occasion for the proposed general framework change.

## 10. Procedure After Action

Supreme Court review of the insufficiency ground is complete. The case returns through the Fourth Circuit for proceedings rejecting that ground and addressing any other properly remaining claim, including the previously unaddressed Elkins new-evidence claim under its own requirements. No new trial, release order, new custody authority, mandate-issuance date, later filing or retained Supreme Court proceeding is established.

## 11. Source Notes

[Official United States Reports, 505 U.S. 277](https://tile.loc.gov/storage-services/service/ll/usrep/usrep505/usrep505277/usrep505277.pdf) verifies the argument and decision dates, docket, participation, procedural record and historical writings. [Full judgment below](https://static.case.law/f2d/931/cases/0262-01.json) supplies the lower posture, alternative or reserved issues and material record. The official report was read in full. Relevant earlier primary opinions supply the legal authorities identified above. Research cutoff: June19,1992. No later connected proceeding or direct quotation is supplied.
...
United States v. Salerno et al., No. 91-872; October Term 1991. Merits decision effective June 19, 1992; argued April 20, 1992. On writ of certiorari to the Second Circuit, reviewing 937 F.2d 797, amended on rehearing at 952 F.2d 623. The District Court excluded defense-offered grand-jury testimony and entered convictions; the court of appeals reversed the appealing defendants' convictions, treating similar motive as dispensable and finding spillover from the evidentiary ruling. This writ concerns seven respondents: Anthony Salerno, Vincent DiNapoli, Louis DiNapoli, Nicholas Auletta, Edward Halloran, Alvin O. Chattin and Aniello Migliore. Ianniello's distinct appellate relief is outside the writ.

Question: whether unavailable witnesses' grand-jury testimony may be admitted for the defense under Rule 804(b)(1) without showing the Government's similar motive to develop it, including the asserted fairness and forfeiture grounds. The United States seeks reversal; respondents defend admission and their appellate relief. This is the evidence case at historical reporter anchor 505 U.S. 317, not the 1987 bail case. The question is a record-grounded formulation, not a verified quotation from the petition. June 19 decisions are independent siblings and share the entering state after the four June 18 events.

Render form: full — the formal controlling-writing coalition changes because Stone concurs in the judgment rather than formally joining Thomas's opinion, and his published qualifications remain distinct.

## 2. Participation

At argument and decision, Chief Justice Alex-Lamar Stone-Zsela and Justices White, Blackmun, Stevens, O'Connor, Scalia, Kennedy, Souter and Thomas participate. All nine are seated, with no case-specific nonparticipation identified. Six constitute a quorum and five control the judgment. Thomas was seated before this argument.

## 3. Public Action

The Court reverses and remands the Second Circuit judgment insofar as it dispenses with the similar-motive requirement. The vote is 8–1; Stevens dissents.

## 4. Judgment & Remedy

| Judgment component | Disposition and vote | Supporting Justices | Opposing Justice | Remedy |
|---|---|---|---|---|
| The Second Circuit's dispensation with similar motive for the seven respondents | Reversed and remanded, 8–1 | Stone-Zsela, White, Blackmun, O'Connor, Scalia, Kennedy, Souter, Thomas | Stevens | Consider actual similar motive and resulting admissibility and judgment consequences; preserve independent appellate grounds. |

The mandate returns the matter to the Second Circuit. It orders neither categorical exclusion nor unconditional reinstatement of every conviction. No special mandate date, stay, immediate retrial or finding about the truth of either witness's account is directed.
...
| Concurrence | Blackmun | No other Justice | Joins the Court in full | Similar motive is a contextual factual inquiry, not identity or an always/never rule. |
| Concurrence in the judgment | Stone-Zsela | No other Justice | Reversal and remand | Every Rule condition, actual comparable motive, no forfeiture from independent contradiction, and retained independent appellate grounds; no formal Court-opinion join. |
| Dissent | Stevens | No other Justice | Would affirm | The existing central-issue record establishes actual opportunity and similar motive; tactical restraint is not absence of motive. |
...
The holding-specific treatment above controls. Green and Dennis retain their specified force; Abel is unchanged. Miller is a Fifth Circuit analogy, not a prior Supreme Court holding. Simulated White and Williams retain the distinct rules described in Law After Decision. No precedent is overruled.

## 8. Law After Decision

Effective June 19, Rule 804(b)(1)'s opportunity and similar-motive requirements apply without the court of appeals' immunity-based fairness exception. Contradiction through independent evidence alone does not forfeit the objection. Before this event no current decision resolved these precise trial-admissibility questions. White v. Illinois (January 15) remains an exception-sensitive Confrontation Clause decision; United States v. Williams (May 4) retains its confined grand-jury disclosure duty and qualified dismissal remedy. Neither supplies automatic trial admission, and neither is overruled or narrowed. The actual motive, other preserved evidentiary/constitutional grounds and their judgment consequences remain unresolved.

## 9. Separate Writings

Blackmun joins the Court and explains that similar does not mean identical. The actual issues and context of questioning govern, with neither a categorical prosecutorial exemption nor automatic admission; he favors remand because the appropriate inquiry was not completed below.
...
Supreme Court review of this merits event is complete. On the ordinary mandate the Second Circuit must consider the actual-motive arguments under the proper Rule and determine their effect together with remaining appellate grounds. No Supreme Court jurisdiction is retained and no later filing or result is assumed.

## 11. Source Notes

The official report, [505 U.S. 317–332](https://www.govinfo.gov/content/pkg/USREPORTS-505/pdf/USREPORTS-505-317.pdf), verifies the argument and decision dates, the seven respondents and public historical facts. The complete [Second Circuit opinion](https://static.case.law/f2d/937/html/0797-01.html) and [rehearing amendment](https://static.case.law/f2d/952/html/0623-01.html) support the posture and separate issues. [Dennis](https://www.govinfo.gov/content/pkg/USREPORTS-384/pdf/USREPORTS-384-855.pdf) and [Abel](https://www.govinfo.gov/content/pkg/USREPORTS-469/pdf/USREPORTS-469-45.pdf) supply earlier authority. The operative Rule is reproduced in the primary opinions. No quotation from an unreviewed petition, independent transcript, or merits brief is asserted. The lower table appendix is image-only in CAP and is not independently read; narrative component and party descriptions support the limited disposition. In-world cutoff: immediately before June 19, 1992, including June 18 effective simulated law; no later law or external sequel is admitted.
