...
**October Term:** 1992. **Matters:** 12. **Event range:** 1993-06-01 through 1993-06-11.
...
**Stone’s Remedy and Remand Position:** Reject the equal-protection challenge to the ownership-based franchising distinction. Leave separate speech claims and challenges to particular applications to their own sources.
...
**Stone’s Proposed Holding:** Congress may distinguish these ownership arrangements for franchising purposes because their bargaining and regulatory characteristics provide a rational basis, even if the line is imperfect.

**Essential Reasoning and Record Application:** Stone accepts ordinary regulatory latitude. Common ownership can change the relationship among provider, property manager, and users, so the line is not merely an unexplained penalty on an unpopular group. He does not convert the weak level of review into a proposition that economic classifications are literally unreviewable.

**Boundary or Reserved Question:** No new tier, no record-building requirement, and no categorical immunity for animus or a classification lacking any rational basis.
...
**Stone’s Remedy and Remand Position:** Reject confirmation on the proposed stripping theory for this partially secured home-mortgage claim. Preserve the debtor’s ability to propose treatment authorized by other applicable provisions.
...
**Stone’s Proposed Holding:** Where the claim retains a secured portion and is secured only by the principal residence, § 1322(b)(2) protects the holder’s rights notwithstanding § 506(a) bifurcation.

**Essential Reasoning and Record Application:** Stone gives valuation its work without treating it as an implied repeal of the specific anti-modification provision. The bank’s contractual rights are identified under state law and then receive the federal protection Congress actually granted. The statutory cure route remains distinct.

**Boundary or Reserved Question:** No ruling on wholly unsecured junior liens, additional collateral, or later amendments.
...
**Current-Through Baseline:** The user-authorized pre-OT1992 historical baseline, independently date-eligible law, and actual simulated law effective immediately before the 1993-06-07 event. Earlier same-day law counts only where its effective sequence is established. This is an authoring baseline, not certification against an unsupplied live decision record.  
...
**Version:** OT1992 reboot, v1.1, audit correction: diversion, mootness, and appellate sequence.  
...
**Stone's Proposed Judgment or Disposition:** REJECT Dickerson’s mootness objection and AFFIRM the Minnesota Supreme Court judgment requiring suppression, while rejecting a categorical rule that touch can never supply probable cause for seizure.
...
##### Issue 1: A live controversy remains after diversion

**Threshold and Merits Reach:** Stone rejects mootness before considering search and seizure. He does not invent an entered judgment of conviction or disregard the completed probation and dismissal.

**Stone's Legal Position:** Apply inherited collateral-consequences doctrine to the legal effect of the retained diversion record.

**Stone's Proposed Holding:** Completion of diversion does not moot this review where reversal could restore a record legally usable against the respondent in subsequent proceedings.

**Essential Reasoning and Record Application:** Section 152.18 removes ordinary conviction disabilities but retains a legally consequential record. Goodrich and Frank identify uses of that record that distinguish this dispute from an abstract disagreement about a completed search. The State’s requested reversal can therefore affect Dickerson’s legal position.

**Boundary or Reserved Question:** No general presumption that every dismissed charge or every expired diversion program remains justiciable. This conclusion rests on the identified consequences of this statutory scheme.

##### Issue 2: Tactile recognition and the end of the frisk
...
**Earlier Same-Term Decisions and Unresolved Dependencies:** Apply only actual earlier simulated Graham and Fretwell holdings, if supplied. Historical Estelle v. McGuire, 502 U.S. 62 (1991), is post-divergence and not silently controlling. An actual Brecht holding matters only if a constitutional trial error is properly reached; it does not bypass Teague.
...
**Stone’s Proposed Judgment or Disposition:** REVERSE the grant of habeas relief on the Teague ground.

**Stone’s Remedy and Remand Position:** Deny relief under the newly applied instructional rule in this collateral proceeding. Do not announce that the instructions are constitutionally valid on direct review or that every defense-instruction error is categorically excluded from due process.
...
**Stone’s Proposed Holding:** The specific rule applied here was not dictated by the earlier authorities, regulates procedure rather than substantive punishability, and is not a watershed procedural change under the then-governing exception.

**Essential Reasoning and Record Application:** Stone does not convert broad fairness language into a dictated answer to every later instructional dispute. The particular rule changes how the defense is considered, not the conduct the State may punish, and it does not remake the fundamental accuracy structure in the exceptional sense Teague requires. The State’s merits concession does not answer those questions.

**Boundary or Reserved Question:** No direct-review approval of the charge and no later-law narrowing of Teague’s exceptions; no need to decide harmless error.
...
**Stone’s Proposed Judgment or Disposition:** AFFIRM on the statutory interpretation, without adopting the lower court’s overbroad reading of Georgetown.

**Stone’s Remedy and Remand Position:** Reject an unconditional right to above-limit reimbursement under this clause. Leave authorized exceptions and independently valid challenges to particular cost methods available.
...
**Stone’s Proposed Holding:** The clause permits reconciliation of interim payments to the amount due under valid reimbursement methods; it does not require an unlimited individualized exception to every cost ceiling.

**Essential Reasoning and Record Application:** Stone gives the adjustment requirement meaningful work within the system Congress created. The opposite construction would undermine the authorized generalizations in cost limits and render specific exceptions largely unnecessary. Actual hardship may support an existing exception but does not rewrite the clause.

**Boundary or Reserved Question:** No validation of an independently unlawful cost method and no elimination of expressly authorized exceptions.

##### Issue 2: Agency interpretation and change of position

**Threshold and Merits Reach:** Reach the preserved issue within the review posture stated in Section I.

**Stone’s Legal Position and Treatment of Precedent:** Apply the entering statutory framework; do not use this case to enact the Master’s different general deference proposal.

**Stone’s Proposed Holding:** The Secretary’s construction fits the statutory scheme and is permissible under the entering framework; changing positions does not alone make it unlawful.

**Essential Reasoning and Record Application:** Stone first reads the enacted structure and finds this interpretation the better fit. He therefore need not use this case to replace Chevron or treat agency preference as a substitute for legal reasoning. The agency’s history is assessed rather than ignored.

**Boundary or Reserved Question:** No general rule that every agency interpretation receives automatic controlling weight.
...
**Stone’s Remedy and Remand Position:** Remove the absolute-judicial-immunity bar. Leave the cause of action, constitutional injury, causation, other defenses, and damages for lawful determination.
...
**Stone’s Proposed Holding:** A court reporter’s ministerial failure to record or produce a transcript is not protected by absolute judicial immunity merely because the task is integral to a trial.

**Essential Reasoning and Record Application:** Stone separates institutional importance from the function carrying the immunity. A reporter must accurately preserve the record rather than decide a dispute. The ruling removes an unsupported defense while leaving the plaintiff to prove an actionable deprivation through an authorized channel.

**Boundary or Reserved Question:** No automatic Bivens cause, no damages finding, and no need to adopt a broader exception for knowing falsification.
...
**Stone’s Remedy and Remand Position:** Restore consideration under the surviving insurance-agency provision. Leave the precise permissible scope of the bank’s activity and the Comptroller’s construction for the remaining proceedings.
...
**Stone’s Proposed Holding:** The insurance-agency authorization was not repealed by the 1918 amendment; the apparent punctuation-based reading cannot override the clearly established structure of the enacted provisions.

**Essential Reasoning and Record Application:** Stone treats textual fidelity as fidelity to the law enacted, not blind attachment to an isolated printer’s mark. The correction is justified by the whole statutory sequence and the unmistakable boundary of the amendment, not by the desirability of bank insurance sales. A necessary legal question can be answered after briefing even if the parties initially framed the case differently.

**Boundary or Reserved Question:** No general license to repair statutes for policy reasons and no final holding on the Comptroller’s geographic interpretation.
...
**Stone’s Remedy and Remand Position:** Require the statutory interest and present-value treatment for the oversecured arrearage claims in these plans. Preserve separate examination of fees, charges, and other claim types.
...
**Stone’s Proposed Holding:** An oversecured arrearage claim cured through deferred plan payments receives the applicable § 506(b) preconfirmation interest and § 1325(a)(5)(B) present-value protection despite contract silence.

**Essential Reasoning and Record Application:** Stone follows the two statutory operations rather than treating cure as a universal exception. Interest accruing before confirmation and value required for delayed payment afterward are not the same award twice. The result depends on oversecurity and the actual plan treatment.

**Boundary or Reserved Question:** No use of the later § 1322(e); no automatic award of every fee or charge and no rule for all undersecured mortgages.
...
**Version:** OT1992 reboot, v1.0.  
**Approval Status:** PROPOSED AND UNAPPROVED. No expressly approved case-specific Stone answer was supplied. This is a newly drafted position, not an inferred approval.  
**Current-Through Baseline:** The user-authorized pre-OT1992 historical baseline, independently date-eligible law, and actual simulated law effective immediately before the 1993-06-11 event. Earlier same-day law counts only where its effective sequence is established. This is an authoring baseline, not certification against an unsupplied live decision record.  
**Conditions:** No approved alternative or fallback is supplied. Material change to the entering law, record, or review scope requires revalidation of this proposed supplement before Stone's runtime stage. The positions below are proposals, not Court holdings or rendered votes.
...
**Other Governing Law and Material Authority:** R.A.V. v. St. Paul, 505 U.S. 377 (1992), addresses discrimination within speech prohibitions. Dawson v. Delaware, 503 U.S. 159 (1992), limits punishment-related use of abstract beliefs without relevance. Barclay v. Florida, 463 U.S. 939 (1983), and Haupt v. United States, 330 U.S. 631 (1947), recognize legally relevant motive or intent. Broadrick v. Oklahoma, 413 U.S. 601 (1973), governs substantial overbreadth rather than speculative chilling.
...
The Wisconsin Supreme Court treated the enhancement as punishment of discriminatory thought and as chilling protected speech used to prove motive. Wisconsin distinguishes a violent act deliberately directed at a victim because of race from a speech restriction and invokes the additional individual and community harms of bias-motivated violence. Mitchell argues that the added punishment nonetheless turns on belief and that R.A.V. forbids selecting disfavored ideas. Wisconsin must retain a real link to intentional victim selection rather than punish ideology alone. The United States supported Wisconsin.
