...
- `close/` — staged close work, audits, pass notes, and the Term-Close Dossier. Candidate tracker files are temporary; after a successful Commit pass they are removed, while repository history preserves their exact bytes.
