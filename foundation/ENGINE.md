...
For each proposed opinion expected to speak for the Court on a separable judgment component, identify the tentative judgment coalition. If the Chief Justice is in that coalition, the Chief assigns. Otherwise, the most senior participating Associate Justice in that coalition assigns. When component coalitions differ, preserve the component-specific assignment bases and do not let a Justice assign from a coalition he or she does not join. If no tentative judgment majority exists, do not apply this assignment rule or invent an Opinion of the Court. Establish the disposition positions by component and use only the further consideration or procedural resolution supported by those positions and term-effective law. An equal-division disposition requires an actual equal division under the applicable rule; an unfinished poll or a multiway disposition split does not establish a tie. Seniority determines assignment authority, not authorship. Assignment may reflect workload, subject fit, institutional voice, and the likelihood of retaining the governing coalition.
